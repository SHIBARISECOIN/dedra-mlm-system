...
## 2026-04-28 유지보수 기록
- 1+1 프로모션 입금 승인 로직을 최종 인수인계 기준에 맞춰 전체 입금액 12개월/360일 상품 전환으로 정합화했습니다.
- 1+1 프로모션 투자 기록에 `dailyRate: 0.007`, `noRollup: true`, `rollupEligible: false`, `commissionEligible: false`, `networkSalesEligible: false` 보호 필드를 추가했습니다.
