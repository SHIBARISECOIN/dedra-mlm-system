...
const TRANSLATIONS = {
  ko: {
    ...
    dwPromoTitle: 'D-WALLET 하나로 완벽하게',
    dwPromoSub: 'SOL, BSC, TRON 네트워크의 USDT를<br>가장 편하게 통합 관리하세요.',
    dwFeat1Title: '네트워크 제한 없는 자유로움',
    dwFeat1Desc: 'TRC-20, BEP-20, SPL 어떤 네트워크로 전송하든 내 D-WALLET으로 즉시 입금 및 통합됩니다.',
    dwFeat2Title: '수수료(가스비) 코인 구매 불필요',
    dwFeat2Desc: 'TRX나 BNB를 따로 준비할 필요가 없습니다. 복잡한 과정은 D-WALLET 시스템이 알아서 처리합니다.',
    dwFeat3Title: '초간편 자산 통합 관리',
    dwFeat3Desc: '흩어진 USDT를 한 화면에서 한눈에 확인하고, 모든 서비스에 즉시 활용하세요.',
    dwConfirmBtn: '확인 완료',
    dwBannerTitle: 'ALL-IN-ONE SYSTEM',
    dwBannerDesc: '복잡한 네트워크 구분 없이<br>USDT 입금을 한 번에! 🚀',
  ...
  en: {
    ...
    dwPromoTitle: 'D-WALLET All-in-One Perfectly',
    dwPromoSub: 'Easily manage your USDT across<br>SOL, BSC, and TRON networks.',
    dwFeat1Title: 'Freedom Without Network Limits',
    dwFeat1Desc: 'Whether TRC-20, BEP-20, or SPL, your transfers are instantly deposited and merged into your D-WALLET.',
    dwFeat2Title: 'No Need to Buy Gas Coins',
    dwFeat2Desc: 'No need to prepare TRX or BNB. The D-WALLET system handles the complex processes for you.',
    dwFeat3Title: 'Super Simple Asset Management',
    dwFeat3Desc: 'Check your scattered USDT at a glance and use it instantly for all services.',
    dwConfirmBtn: 'Confirm',
    dwBannerTitle: 'ALL-IN-ONE SYSTEM',
    dwBannerDesc: 'Deposit USDT at once<br>without worrying about complex networks! 🚀',
  ...
  vi: {
    ...
    dwPromoTitle: 'D-WALLET Hoàn hảo trong Một',
    dwPromoSub: 'Dễ dàng quản lý USDT của bạn<br>trên các mạng SOL, BSC và TRON.',
    dwFeat1Title: 'Tự do Không giới hạn Mạng lưới',
    dwFeat1Desc: 'Dù là TRC-20, BEP-20 hay SPL, các khoản chuyển của bạn sẽ được nạp và hợp nhất ngay lập tức vào D-WALLET.',
    dwFeat2Title: 'Không cần mua Coin làm Phí Gas',
    dwFeat2Desc: 'Không cần chuẩn bị TRX hay BNB. Hệ thống D-WALLET sẽ xử lý các quy trình phức tạp cho bạn.',
    dwFeat3Title: 'Quản lý Tài sản Siêu Đơn giản',
    dwFeat3Desc: 'Kiểm tra số USDT rải rác của bạn chỉ trong nháy mắt và sử dụng ngay cho mọi dịch vụ.',
    dwConfirmBtn: 'Xác nhận',
    dwBannerTitle: 'HỆ THỐNG ALL-IN-ONE',
    dwBannerDesc: 'Nạp USDT ngay lập tức<br>mà không cần phân biệt mạng lưới phức tạp! 🚀',
  ...
  th: {
    ...
    dwPromoTitle: 'D-WALLET สมบูรณ์แบบในหนึ่งเดียว',
    dwPromoSub: 'จัดการ USDT ของคุณอย่างง่ายดาย<br>ข้ามเครือข่าย SOL, BSC และ TRON',
    dwFeat1Title: 'อิสระไร้ขีดจำกัดของเครือข่าย',
    dwFeat1Desc: 'ไม่ว่าจะเป็น TRC-20, BEP-20 หรือ SPL การโอนของคุณจะถูกฝากและรวมเข้ากับ D-WALLET ของคุณทันที',
    dwFeat2Title: 'ไม่ต้องซื้อเหรียญเป็นค่าแก๊ส',
    dwFeat2Desc: 'ไม่ต้องเตรียม TRX หรือ BNB ระบบ D-WALLET จัดการกระบวนการที่ซับซ้อนให้คุณเอง',
    dwFeat3Title: 'การจัดการสินทรัพย์ที่ง่ายดาย',
    dwFeat3Desc: 'ตรวจสอบ USDT ที่กระจัดกระจายของคุณได้ในพริบตาและใช้งานได้ทันทีสำหรับทุกบริการ',
    dwConfirmBtn: 'ยืนยัน',
    dwBannerTitle: 'ระบบ ALL-IN-ONE',
    dwBannerDesc: 'ฝาก USDT ในครั้งเดียว<br>โดยไม่ต้องแยกแยะเครือข่ายที่ซับซ้อน! 🚀',
