...
const TRANSLATIONS = {
  ko: {
    myHolding: '내', holdingAmt: '보유량', currentValue: '현재 가치', networkBalanceTitle: '네트워크별 보유 잔고',
    h1Change: '1시간 변화', h6Change: '6시간 변화', h24Change: '1일(24h) 변화',
    detailSummary: '상세 정보 요약', marketCap: '시가총액 (FDV)', volume24h: '24시간 거래량', liquidity: '유동성 (Liquidity)', addressLabel: '주소',
    convertView: '변환 보기', revertView: '원래대로',
    emptyHistory: '해당 날짜에 일치하는 내역이 없습니다.',
    infoTitle: '정보', loadingBlockchain: '블록체인 데이터 불러오는 중...', currentPrice: '현재 시세',
    notFoundTitle: '시세 정보를 불러올 수 없습니다.', notFoundDesc: 'DEX 거래소에 아직 상장되지 않았거나 데이터 제공처(DexScreener)에서 지원하지 않는 토큰입니다.',
    networkErrorTitle: '데이터 통신 오류가 발생했습니다.', networkErrorDesc: '네트워크 상태를 확인하고 다시 시도해주세요.',
    viewAllPeriodBtn: '과거 전체 기간 조회하기',
    viewDetailsBtn: '상세 내역 5건씩 보기',
    loadMore: '다음 5개 내역 더보기',
    totalSum: '합계',
    totalCount: '조회 건수',
    countUnit: '건',
    txDeposit: '입금',
    txWithdraw: '출금',
    txInvest: 'FREEZE 및 일일수익',
    txDirectBonus: '추천 수당',
    txRankBonus: '직급 수당',
    ...
    wallet_promo_desc: '복잡한 네트워크 구분 없이<br>USDT 입금을 한 번에! 🚀',
    ...
    dwalletItem3Desc: '흩어진 USDT를 한 화면에서 한눈에 확인하고, 모든 서비스에 즉시 활용하세요.',
    dwalletConfirm: '확인 완료',
    ...
    assetLocked: 'USDT 원금<br><span style="font-size:11px;opacity:0.7">(Locked)</span>',
    ...
    dexFeeZero: 'D-WALLET 우선 · 외부지갑 선택 가능',
    btnBuy: '매수 (Buy)',
    btnSell: '매도 (Sell)',
  ...
  en: {
    myHolding: 'My', holdingAmt: 'Holdings', currentValue: 'Current Value', networkBalanceTitle: 'Balance by Network',
    h1Change: '1H Change', h6Change: '6H Change', h24Change: '24H Change',
    detailSummary: 'Details Summary', marketCap: 'Market Cap (FDV)', volume24h: '24H Volume', liquidity: 'Liquidity', addressLabel: 'Address',
    convertView: 'Conversion', revertView: 'Original',
    emptyHistory: 'No matching records for this date.',
    infoTitle: 'Info', loadingBlockchain: 'Loading blockchain data...', currentPrice: 'Current Price',
    notFoundTitle: 'Cannot load price data.', notFoundDesc: 'Token is not yet listed on DEX or unsupported by the data provider.',
    networkErrorTitle: 'Network Communication Error', networkErrorDesc: 'Please check your connection and try again.',
    viewAllPeriodBtn: 'View full past history',
    viewDetailsBtn: 'View 5 details at a time',
    loadMore: 'Load next 5 records',
    totalSum: 'Total',
    totalCount: 'Record Count',
    countUnit: ' items',
    txDeposit: 'Deposit',
    txWithdraw: 'Withdrawal',
    txInvest: 'FREEZE & Daily ROI',
    txDirectBonus: 'Referral Bonus',
    txRankBonus: 'Rank Bonus',
    txRankMatching: 'Rank Matching',
    txCenterFee: 'Center Fee',
    txPending: 'Pending',
    txProcessing: 'Processing',
    txSwap: 'Swap',
    txDailyRoi: 'Daily ROI',
    txRankReward: 'Rank Reward',
    fee: 'Fee',
    wallet_my_address: 'My Unique Address',
    wallet_create_btn: 'Create My Deedra Wallet',
    wallet_owned_coins: 'Owned Coins',
    wallet_banner_title: '💡 Use Deedra Wallet for USDT!',
    ...
    wallet_promo_desc: 'Deposit USDT across any network<br>all at once! 🚀',
    dwalletModalTitle: 'All-in-one D-WALLET',
    dwalletModalSubtitle: 'Manage your USDT from SOL, BSC, and TRON networks<br>seamlessly in one place.',
    dwalletItem1Title: 'Network-free Freedom',
    dwalletItem1Desc: 'Whether you send via TRC-20, BEP-20, or SPL, it’s instantly deposited and unified in your D-WALLET.',
    dwalletItem2Title: 'No Need for Gas Coins',
    dwalletItem2Desc: 'No need to prepare TRX or BNB. The D-WALLET system handles the complex processes automatically.',
    dwalletItem3Title: 'Super Simple Asset Management',
    dwalletItem3Desc: 'View your scattered USDT at a glance and utilize them instantly for all services.',
    dwalletConfirm: 'Got it',
    ...
    assetLocked: 'Principal<br><span style="font-size:11px;opacity:0.7">(Locked)</span>',
    ...
    dexFeeZero: 'D-WALLET first · External wallet optional',
    btnBuy: 'Buy',
    btnSell: 'Sell',
  ...
  vi: {
    myHolding: 'Của tôi', holdingAmt: 'Số dư', currentValue: 'Giá trị hiện tại', networkBalanceTitle: 'Số dư theo mạng lưới',
    h1Change: 'Thay đổi 1H', h6Change: 'Thay đổi 6H', h24Change: 'Thay đổi 24H',
    detailSummary: 'Tóm tắt chi tiết', marketCap: 'Vốn hóa (FDV)', volume24h: 'Khối lượng 24H', liquidity: 'Thanh khoản', addressLabel: 'Địa chỉ',
    convertView: 'Quy đổi', revertView: 'Ban đầu',
    emptyHistory: 'Không có hồ sơ nào phù hợp.',
    infoTitle: 'Thông tin', loadingBlockchain: 'Đang tải dữ liệu blockchain...', currentPrice: 'Giá hiện tại',
    notFoundTitle: 'Không thể tải thông tin giá.', notFoundDesc: 'Token chưa được niêm yết trên DEX hoặc không được hỗ trợ.',
    networkErrorTitle: 'Lỗi giao tiếp mạng', networkErrorDesc: 'Vui lòng kiểm tra kết nối mạng và thử lại.',
    viewAllPeriodBtn: 'Xem toàn bộ lịch sử',
    viewDetailsBtn: 'Xem 5 chi tiết mỗi lần',
    loadMore: 'Tải thêm 5 hồ sơ',
    totalSum: 'Tổng cộng',
    totalCount: 'Số lượng',
    countUnit: ' mục',
    txDeposit: 'Nạp tiền',
    txWithdraw: 'Rút tiền',
    txInvest: 'FREEZE & Lợi nhuận',
    txDirectBonus: 'Thưởng giới thiệu',
    txRankBonus: 'Thưởng cấp bậc',
    txRankMatching: 'Thưởng kết hợp',
    txCenterFee: 'Phí trung tâm',
    txPending: 'Đang chờ',
    txProcessing: 'Đang xử lý',
    txSwap: 'Hoán đổi',
    txDailyRoi: 'Lợi nhuận ngày',
    txRankReward: 'Thưởng thăng cấp',
    fee: 'Phí',
    ...
    wallet_btn_history: 'Lịch sử',
    wallet_promo_desc: 'Nạp USDT qua mọi mạng lưới<br>chỉ trong một lần! 🚀',
    dwalletModalTitle: 'Ví D-WALLET Tất Cả Trong Một',
    dwalletModalSubtitle: 'Quản lý USDT từ mạng SOL, BSC và TRON<br>một cách dễ dàng nhất.',
    dwalletItem1Title: 'Tự Do Không Giới Hạn Mạng',
    dwalletItem1Desc: 'Dù bạn gửi qua TRC-20, BEP-20 hay SPL, tiền sẽ lập tức được nạp và gộp vào D-WALLET của bạn.',
    dwalletItem2Title: 'Không Cần Mua Coin Làm Phí (Gas)',
    dwalletItem2Desc: 'Không cần chuẩn bị riêng TRX hay BNB. Hệ thống D-WALLET sẽ tự động xử lý mọi quy trình phức tạp.',
    dwalletItem3Title: 'Quản Lý Tài Sản Siêu Đơn Giản',
    dwalletItem3Desc: 'Xem toàn bộ USDT phân tán của bạn ngay trên một màn hình và sử dụng ngay cho mọi dịch vụ.',
    dwalletConfirm: 'Xác nhận',
    ...
    assetLocked: 'Gốc USDT<br><span style="font-size:11px;opacity:0.7">(Đã khóa)</span>',
    ...
    dexFeeZero: 'Ưu tiên D-WALLET · Có thể dùng ví ngoài',
    btnBuy: 'Mua (Buy)',
    btnSell: 'Bán (Sell)',
  ...
  th: {
    myHolding: 'ของฉัน', holdingAmt: 'ยอดคงเหลือ', currentValue: 'มูลค่าปัจจุบัน', networkBalanceTitle: 'ยอดคงเหลือตามเครือข่าย',
    h1Change: 'การเปลี่ยนแปลง 1H', h6Change: 'การเปลี่ยนแปลง 6H', h24Change: 'การเปลี่ยนแปลง 24H',
    detailSummary: 'สรุปรายละเอียด', marketCap: 'มูลค่าตลาด (FDV)', volume24h: 'ปริมาณการซื้อขาย 24H', liquidity: 'สภาพคล่อง (Liquidity)', addressLabel: 'ที่อยู่',
    convertView: 'การแปลง', revertView: 'ดั้งเดิม',
    emptyHistory: 'ไม่พบประวัติในวันนี้',
    infoTitle: 'ข้อมูล', loadingBlockchain: 'กำลังโหลดข้อมูลบล็อกเชน...', currentPrice: 'ราคาปัจจุบัน',
    notFoundTitle: 'ไม่สามารถโหลดข้อมูลราคาได้', notFoundDesc: 'โทเค็นนี้ยังไม่ได้ลงทะเบียนใน DEX หรือผู้ให้บริการข้อมูลไม่รองรับ',
    networkErrorTitle: 'เกิดข้อผิดพลาดในการสื่อสาร', networkErrorDesc: 'โปรดตรวจสอบการเชื่อมต่ออินเทอร์เน็ตแล้วลองอีกครั้ง',
    viewAllPeriodBtn: 'ดูประวัติทั้งหมด',
    viewDetailsBtn: 'ดูรายละเอียดทีละ 5 รายการ',
    loadMore: 'โหลดเพิ่มอีก 5 รายการ',
    totalSum: 'ผลรวม',
    totalCount: 'จำนวน',
    countUnit: ' รายการ',
    txDeposit: 'เงินฝาก',
    txWithdraw: 'การถอนเงิน',
    txInvest: 'FREEZE & รายได้รายวัน',
    txDirectBonus: 'โบนัสแนะนำ',
    txRankBonus: 'โบนัสอันดับ',
    txRankMatching: 'โบนัสจับคู่',
    txCenterFee: 'ค่าธรรมเนียมศูนย์',
    txPending: 'รอดำเนินการ',
    txProcessing: 'กำลังประมวลผล',
    txSwap: 'แลกเปลี่ยน',
    txDailyRoi: 'รายได้รายวัน',
    txRankReward: 'รางวัลเลื่อนตำแหน่ง',
    fee: 'ค่าธรรมเนียม',
    wallet_my_address: 'ที่อยู่ของฉัน (Address)',
    wallet_create_btn: 'สร้างกระเป๋า Deedra ของฉัน',
    wallet_owned_coins: 'เหรียญที่ครอบครอง',
    wallet_banner_title: '💡 ใช้ Deedra Wallet สำหรับการฝาก/ถอน USDT!',
    ...
    wallet_promo_desc: 'ฝาก USDT ข้ามเครือข่ายได้<br>ในครั้งเดียว! 🚀',
    dwalletModalTitle: 'ครบจบในที่เดียวกับ D-WALLET',
    dwalletModalSubtitle: 'จัดการ USDT ของคุณจากเครือข่าย SOL, BSC และ TRON<br>ได้อย่างราบรื่นในที่เดียว.',
    dwalletItem1Title: 'อิสระไร้ขีดจำกัดจากเครือข่าย',
    dwalletItem1Desc: 'ไม่ว่าคุณจะโอนผ่าน TRC-20, BEP-20 หรือ SPL เงินจะเข้าสู่และรวมกันใน D-WALLET ของคุณทันที.',
    dwalletItem2Title: 'ไม่จำเป็นต้องมีเหรียญค่าแก๊ส',
    dwalletItem2Desc: 'ไม่จำเป็นต้องเตรียม TRX หรือ BNB อีกต่อไป ระบบ D-WALLET จัดการกระบวนการที่ซับซ้อนให้คุณอัตโนมัติ.',
    dwalletItem3Title: 'การจัดการสินทรัพย์ที่เรียบง่าย',
    dwalletItem3Desc: 'ดู USDT ที่กระจัดกระจายของคุณได้อย่างชัดเจน และใช้งานได้ทันทีสำหรับบริการทั้งหมด.',
    dwalletConfirm: 'เข้าใจแล้ว',
    ...
    assetLocked: 'เงินต้น<br><span style="font-size:11px;opacity:0.7">(ล็อค)</span>',
    ...
    dexFeeZero: 'ใช้ D-WALLET ก่อน · เลือกกระเป๋าภายนอกได้',
    btnBuy: 'ซื้อ (Buy)',
    btnSell: 'ขาย (Sell)',
...
window.copyAddress = function(type) {
    ...
    let addr = '';
    if (type === 'sol') addr = userData.deedraWallet.publicKey;
    else if (type === 'bsc') addr = userData.deedraWallet.evmAddress || userData.deedraWallet.bscAddress || userData.deedraWallet.ethAddress;
    else if (type === 'eth') addr = userData.deedraWallet.evmAddress || userData.deedraWallet.ethAddress;
    else if (type === 'tron') addr = userData.deedraWallet.tronAddress;
    
    if (addr) {
        if (navigator.clipboard) {
            navigator.clipboard.writeText(addr).then(() => {
                showToast(t('toastCopied') || '복사 완료', 'success');
            }).catch(() => {
...
window.showDwalletPromoModal = function() {
    const m = document.getElementById('dwalletPromoModal');
    if (m) {
...
window.showMultiChainUsdtDetails = function() {
    window.showTokenDetails('USDT', 'Es9vMFrzaCERmJfrF4H2FYD4KCoNkY11McCe8BenwNYB');
};

window.closeMultiChainUsdtDetails = function() {
    const m = document.getElementById('usdtDetailsModal');
    if (m) {
        m.classList.add('hidden');
        m.style.display = 'none';
    }
...
function applyLang() {
  document.querySelectorAll('[data-i18n], [data-i18n-html]').forEach(el => {
    ...
    if (!key && el.hasAttribute('data-i18n-html')) {
        key = el.getAttribute('data-i18n-html');
        isHtml = true;
    }
    isHtml = isHtml || el.getAttribute('data-i18n-html') === 'true';
...
window.togglePrivacy = function() {
  ...
  var quickToggle = document.getElementById('quickPrivacyToggle');
  if (quickToggle) {
    if (isPrivacyMode) {
      quickToggle.classList.remove('fa-eye');
      quickToggle.classList.add('fa-eye-slash');
      quickToggle.style.color = 'rgba(255,255,255,0.8)';
    } else {
      quickToggle.classList.remove('fa-eye-slash');
      quickToggle.classList.add('fa-eye');
      quickToggle.style.color = 'rgba(255,255,255,0.5)';
    }
  }
...
const GAME_SETTLEMENT_DISABLED = true;
let oeBetVal = 10;
let diceBetVal = 10;
let slotBetVal = 10;
...
let recentTxCache = [];
let recentTxCacheAt = 0;
let premiumWalletTxCache = [];
let premiumWalletTxCacheAt = 0;
const FAST_CACHE_TTL_MS = 60 * 1000;
const FAST_PRODUCT_LIMIT = 60;
const FAST_HOME_TX_LIMIT = 12;
const FAST_NOTI_LISTENER_LIMIT = 20;
const FAST_NOTI_MODAL_LIMIT = 20;
const PREMIUM_WALLET_TX_LIMIT = 24;
const PREMIUM_WALLET_CACHE_TTL_MS = 30 * 1000;

function isFastCacheFresh(ts, ttl = FAST_CACHE_TTL_MS) {
  return ts && (Date.now() - ts < ttl);
}

async function getCachedInvestmentProducts(force = false) {
  if (!force && productsCache.length && isFastCacheFresh(productsCacheAt)) return productsCache;
  const { collection, query, getDocs, limit, db } = window.FB;
  const snap = await getDocs(query(collection(db, 'products'), limit(FAST_PRODUCT_LIMIT)));
  const allDocs = snap.docs.map(d => ({ id: d.id, ...d.data() }));
  productsCache = allDocs
    .filter(p => (!p.type || p.type === 'investment') && p.isActive !== false)
    .sort((a, b) => (a.sortOrder || a.order || a.minAmount || 0) - (b.sortOrder || b.order || b.minAmount || 0));
...
function showGameSettlementDisabled() {
  window._isGameProcessing = false;
  showToast('게임은 서버 정산 방식으로 전환 중입니다. 잠시 이용이 중지되었습니다.', 'warning');
}
  ...
  try {
    ...
    window._userUnsubscribe = window.FB.onSnapshot(doc(db, 'users', currentUser.uid), (docSnap) => {
      if (docSnap.exists()) {
        ...
        if (newData.systemAlertPopup && !window._hasShownSystemAlert) {

            window._hasShownSystemAlert = true;
            ...
            setTimeout(() => {
                ...
                if (typeof Swal !== "undefined") {
                    ...
                    Swal.fire({
                        ...
                        html: "<div style=\"font-size:14px; text-align:left; line-height:1.6; color:#ef4444;\">" + newData.systemAlertPopup.replace(/\n/g, "<br>") + "</div>",

                        icon: "warning",

                        confirmButtonText: "확인 및 알림창 이동",
                        ...
                        window.FB.updateDoc(window.FB.doc(window.FB.db, "users", currentUser.uid), { systemAlertPopup: window.FB.deleteField() }).catch(()=>{});
                    ...
                    alert(newData.systemAlertPopup);
        ...
        // ── 출금 취소 공지 팝업 ──
        if (newData.showWithdrawRejectNotice && !window._hasShownRejectNotice) {
            window._hasShownRejectNotice = true;
            setTimeout(() => {
                if (typeof Swal !== 'undefined') {
                    Swal.fire({
                        title: '출금 신청 취소 안내',
                        html: '<div style="font-size:14px; text-align:left; line-height:1.6; color:#64748b;">시스템 정산 오류(과거 수당 중복 소급) 수정 작업으로 인해<br>기존에 대기 중이던 출금 신청이 <b>전체 취소 및 환불</b> 처리되었습니다.<br><br>고객님의 지갑 잔액이 정상적으로 복구/수정되었으니<br>잔액을 확인하신 후 <b>다시 출금을 신청</b>해 주시기 바랍니다.<br>이용에 불편을 드려 대단히 죄송합니다.</div>',
                        icon: 'info',
                        ...
                        window.FB.updateDoc(window.FB.doc(window.FB.db, 'users', currentUser.uid), { showWithdrawRejectNotice: false }).catch(()=>{});
                    });
                } else {
                    alert("출금 신청 취소 안내\n\n시스템 정산 오류 수정으로 인해 대기 중이던 출금 신청이 취소/환불되었습니다.\n정상 잔액을 확인하신 후 다시 신청해 주시기 바랍니다.");
                    window.FB.updateDoc(window.FB.doc(window.FB.db, 'users', currentUser.uid), { showWithdrawRejectNotice: false }).catch(()=>{});
                }
            }, 1500);
        }
...
async function loadHomeEarn() {
  ...
  try {
    const { collection, getDocs, query, where, limit, db } = window.FB;

    // 상품 로드 (제한 조회 + 60초 캐시)
    productsCache = await getCachedInvestmentProducts(false);

    // 내 활성 투자 로드 (홈 화면에서는 최신 10건만 빠르게 가져옴)
    let myInvestments = [];
    if (currentUser) {
      try {
        const q = query(collection(db, 'investments'), where('userId', '==', currentUser.uid), where('status', '==', 'active'), limit(10));
...
window.changeLang = function(lang) {
  ...
  if (typeof currentPage !== 'undefined' && currentPage) {
    if (currentPage === 'home') {
      ...
      if (typeof window.renderPremiumWalletCenter === 'function') window.renderPremiumWalletCenter();
      if (typeof window.loadPremiumWalletTimeline === 'function') window.loadPremiumWalletTimeline(true);
...
function updateWalletUI() {
  ...
  updateHomeUI();
  if (typeof window.renderPremiumWalletCenter === 'function') window.renderPremiumWalletCenter();
  if (currentPage === 'wallet' && typeof window.loadPremiumWalletTimeline === 'function') {
    window.loadPremiumWalletTimeline();
  }
...
async function loadAnnouncements() {
  ...
  try {
    let sourceItems = announcementsCache;
    if (!sourceItems.length || !isFastCacheFresh(announcementsCacheAt)) {
      const q = query(
      ...
      announcementsCacheAt = Date.now();
      sourceItems = announcementsCache;
    }
...
window.showAnnouncementModal = async function() {
  ...
  try {
    let sourceItems = announcementsCache;
    if (!sourceItems.length || sourceItems.length < 20 || !isFastCacheFresh(announcementsCacheAt)) {
      const q = query(
        collection(db, 'announcements'),
        orderBy('createdAt', 'desc'),
        limit(20)
...
async function loadRecentTransactions() {
  const { collection, query, where, getDocs, limit, db } = window.FB;
  try {
    if (recentTxCache.length && isFastCacheFresh(recentTxCacheAt, 15 * 1000)) {
      renderTxList(recentTxCache, 'recentTxList');
      return;
    }
    const q = query(
      collection(db, 'transactions'),
      where('userId', '==', currentUser.uid),
      limit(FAST_HOME_TX_LIMIT)
    );
    const snap = await getDocs(q);
...
function premiumWalletNumber(value) {
  const n = Number(value || 0);
  return Number.isFinite(n) ? n : 0;
}

function premiumWalletFormatUsdt(value) {
  return privacyFmt(fmt(premiumWalletNumber(value)), '', ' USDT');
}

function premiumWalletFormatDdra(value) {
  return privacyFmt(fmt(premiumWalletNumber(value)), '', ' DDRA');
}

function premiumWalletEscapeHtml(value) {
...
function premiumWalletTxTime(tx) {
...
function premiumWalletTxAmount(tx) {
  if (!tx) return 0;
  if (tx.amountUsdt !== undefined) return premiumWalletNumber(tx.amountUsdt);
  if (tx.amount !== undefined) return premiumWalletNumber(tx.amount);
  if (tx.toAmount !== undefined) return premiumWalletNumber(tx.toAmount);
  return 0;
}

function premiumWalletTxStatusLabel(status) {
  const s = String(status || '').toLowerCase();
  const map = {
    pending: t('statusPending') || '승인 대기',
    processing: t('txProcessing') || '처리중',
    processing_lock: t('txProcessing') || '처리중',
    held: t('statusHeld') || '보류중',
    approved: t('statusApproved') || '완료',
    completed: t('statusCompleted') || '완료',
    rejected: t('statusRejected') || '거부됨',
    failed: '실패'
  };
  return map[s] || status || '-';
}

function premiumWalletTxStatusColor(status) {
  const s = String(status || '').toLowerCase();
  if (['approved', 'completed'].includes(s)) return '#34d399';
  if (['pending', 'processing', 'processing_lock', 'held'].includes(s)) return '#fbbf24';
  if (['rejected', 'failed'].includes(s)) return '#f87171';
  return '#94a3b8';
}

function premiumWalletExplorerUrl(network, kind, value) {
  const clean = encodeURIComponent(String(value || ''));
  if (!clean) return '';
  const net = String(network || '').toLowerCase();
  const isTx = kind === 'tx';
  if (net.includes('bsc') || net.includes('bnb') || net.includes('bep')) {
    return `https://bscscan.com/${isTx ? 'tx' : 'address'}/${clean}`;
  }
  if (net.includes('tron') || net.includes('trx') || net.includes('trc')) {
    return `https://tronscan.org/#/${isTx ? 'transaction' : 'address'}/${clean}`;
  }
  return `https://solscan.io/${isTx ? 'tx' : 'account'}/${clean}`;
}

function getPremiumWalletTxHash(tx) {
  return tx?.txid || tx?.txId || tx?.txHash || tx?.transactionHash || tx?.signature || tx?.chainTxId || '';
}

function premiumWalletResolveMemberId() {
  const fromUser = userData?.username || userData?.referralCode || userData?.memberId || '';
  if (fromUser) return String(fromUser);
  const fallback = currentUser?.uid || '';
  return fallback ? fallback.substring(0, 10).toUpperCase() : '-';
}

function premiumWalletBuildSnapshot() {
  const w = walletData || {};
  const txs = Array.isArray(premiumWalletTxCache) ? premiumWalletTxCache : [];
  const availableUsdt = premiumWalletNumber(w.usdtBalance);
  const rewardUsdt = premiumWalletNumber(w.bonusBalance);
  const lockedUsdt = premiumWalletNumber(w.totalInvest) + premiumWalletNumber(w.bonusInvest);
  const centerUsdt = premiumWalletNumber(w.centerBalance) + premiumWalletNumber(w.subCenterBalance);
  const pendingTxs = txs.filter((tx) => ['pending', 'processing', 'processing_lock', 'held'].includes(String(tx.status || '').toLowerCase()));
  const pendingUsdt = pendingTxs.reduce((sum, tx) => sum + premiumWalletTxAmount(tx), 0);
  const serviceTotal = availableUsdt + rewardUsdt + lockedUsdt + centerUsdt;
  const price = premiumWalletNumber(deedraPrice) || 0.5;

  return {
    availableUsdt,
    rewardUsdt,
    rewardDdra: rewardUsdt / price,
    lockedUsdt,
    centerUsdt,
    pendingUsdt,
...
function premiumWalletRenderTimeline() {
  const el = document.getElementById('premiumWalletTimeline');
  if (!el) return;
  const txs = (Array.isArray(premiumWalletTxCache) ? premiumWalletTxCache : [])
    .slice()
    .sort((a, b) => premiumWalletTxTime(b) - premiumWalletTxTime(a))
    .slice(0, 6);
  window._premiumWalletTimelineRows = txs;

  if (!txs.length) {
    el.innerHTML = '<div style="color:#94a3b8; font-size:12px; padding:10px 0; text-align:center;">최근 거래 흐름이 없습니다.</div>';
    return;
  }

  const plusTypes = ['deposit', 'bonus', 'direct_bonus', 'rank_bonus', 'rank_gap_passthru', 'rank_equal_or_higher_override', 'rank_equal_or_higher_override_1pct', 'daily_roi', 'roi', 'roi_income', 'center_fee', 'sub_center_fee'];
  const neutralTypes = ['swap'];
  const icons = { deposit: 'fa-arrow-down', withdrawal: 'fa-arrow-up', invest: 'fa-lock', swap: 'fa-exchange-alt', bonus: 'fa-gift', daily_roi: 'fa-sun', roi: 'fa-sun', roi_income: 'fa-sun', center_fee: 'fa-building' };

  el.innerHTML = txs.map((tx, idx) => {
    const type = String(tx.type || '');
    const isPlus = plusTypes.includes(type);
    const isNeutral = neutralTypes.includes(type);
    const amount = premiumWalletTxAmount(tx);
    const amountColor = isNeutral ? '#f8fafc' : (isPlus ? '#34d399' : '#f87171');
    const sign = isNeutral ? '' : (isPlus ? '+' : '-');
    const statusColor = premiumWalletTxStatusColor(tx.status);
    const currency = premiumWalletEscapeHtml(tx.currency || 'USDT');
    const title = premiumWalletEscapeHtml(getTxTypeName(type));
    const status = premiumWalletEscapeHtml(premiumWalletTxStatusLabel(tx.status));
    const dateText = premiumWalletEscapeHtml(fmtDate(tx.createdAt));
    const icon = icons[type] || 'fa-receipt';

    return `
      <div onclick="window.showPremiumWalletTxDetail(${idx})" style="display:flex; align-items:center; gap:10px; min-width:0; padding:9px 0; border-top:1px solid rgba(255,255,255,0.05); cursor:pointer;" onmouseover="this.style.background='rgba(255,255,255,0.035)'" onmouseout="this.style.background='transparent'">
        <div style="width:32px; height:32px; border-radius:10px; background:rgba(255,255,255,0.06); display:flex; align-items:center; justify-content:center; color:${amountColor}; flex-shrink:0;">
          <i class="fas ${icon}" style="font-size:12px;"></i>
        </div>
        <div style="flex:1; min-width:0;">
          <div style="display:flex; align-items:center; gap:6px; min-width:0;">
            <div style="color:#f8fafc; font-size:12.5px; font-weight:800; white-space:nowrap; overflow:hidden; text-overflow:ellipsis;">${title}</div>
            <div style="font-size:9.5px; font-weight:800; color:${statusColor}; background:rgba(255,255,255,0.05); border:1px solid rgba(255,255,255,0.06); border-radius:999px; padding:2px 6px; flex-shrink:0;">${status}</div>
          </div>
          <div style="color:#94a3b8; font-size:10.5px; margin-top:3px;">${dateText}</div>
        </div>
        <div style="color:${amountColor}; font-size:12.5px; font-weight:900; text-align:right; flex-shrink:0; max-width:110px; word-break:break-word;">${sign}${privacyFmt(fmt(amount), '', ' ' + currency)}</div>
        <i class="fas fa-chevron-right" style="color:#64748b; font-size:10px; flex-shrink:0;"></i>
      </div>`;
  }).join('');
}

function renderPremiumWalletCenter() {
  const root = document.getElementById('premiumWalletCenter');
  if (!root) return;
  ...
  const snapshot = premiumWalletBuildSnapshot();
  const hasWallet = !!(userData && userData.deedraWallet && userData.deedraWallet.publicKey);
  const health = document.getElementById('premiumWalletHealth');
  const status = document.getElementById('premiumWalletFlowStatus');

  setText('premiumWalletMemberId', premiumWalletResolveMemberId());
  setText('premiumWalletServiceTotal', premiumWalletFormatUsdt(snapshot.serviceTotal));
  setText('premiumWalletAvailableUsdt', premiumWalletFormatUsdt(snapshot.availableUsdt));
  setText('premiumWalletLockedUsdt', premiumWalletFormatUsdt(snapshot.lockedUsdt));
  setText('premiumWalletRewardUsdt', premiumWalletFormatUsdt(snapshot.rewardUsdt));
  setText('premiumWalletRewardDdra', '≈ ' + premiumWalletFormatDdra(snapshot.rewardDdra));
  setText('premiumWalletPendingUsdt', premiumWalletFormatUsdt(snapshot.pendingUsdt));
  setText('premiumWalletCenterUsdt', premiumWalletFormatUsdt(snapshot.centerUsdt));

  const syncText = premiumWalletTxCacheAt
    ? 'Last sync ' + new Date(premiumWalletTxCacheAt).toLocaleTimeString('ko-KR', { hour: '2-digit', minute: '2-digit' })
    : 'Wallet snapshot';
  setText('premiumWalletUpdatedAt', syncText);

  if (health) {
    if (!hasWallet) {
      health.textContent = 'SETUP';
      health.style.color = '#fbbf24';
      health.style.background = 'rgba(245,158,11,0.14)';
      health.style.borderColor = 'rgba(245,158,11,0.25)';
      ...
      health.style.background = 'rgba(16,185,129,0.14)';
      health.style.borderColor = 'rgba(16,185,129,0.25)';
    }
  }

  if (status) {
    if (!hasWallet) status.textContent = '지갑 발급 필요';
    else if (snapshot.pendingCount > 0) status.textContent = snapshot.pendingCount + '건 처리중';
    else if (snapshot.txCount > 0) status.textContent = '최근 ' + Math.min(snapshot.txCount, 6) + '건 표시';
    else status.textContent = '대기 내역 없음';
  }

  premiumWalletRenderTimeline();
}

async function loadPremiumWalletTimeline(force = false) {
  if (!currentUser || !window.FB) return;
  if (!force && premiumWalletTxCache.length && isFastCacheFresh(premiumWalletTxCacheAt, PREMIUM_WALLET_CACHE_TTL_MS)) {
    renderPremiumWalletCenter();
    return;
  }
  ...
  try {
    const q = query(
      collection(db, 'transactions'),
      where('userId', '==', currentUser.uid),
      limit(PREMIUM_WALLET_TX_LIMIT)
    );
    const snap = await getDocs(q);
    premiumWalletTxCache = snap.docs
      .map(d => ({ id: d.id, ...d.data() }))
      .filter(tx => tx.status !== 'rejected' || tx.type === 'withdrawal')
      .sort((a, b) => premiumWalletTxTime(b) - premiumWalletTxTime(a));
    premiumWalletTxCacheAt = Date.now();
    renderPremiumWalletCenter();
  } catch (err) {
    console.warn('[PremiumWallet] timeline load failed:', err);
    premiumWalletTxCache = premiumWalletTxCache || [];
    premiumWalletTxCacheAt = Date.now();
    renderPremiumWalletCenter();
  }
}

window.renderPremiumWalletCenter = renderPremiumWalletCenter;
window.loadPremiumWalletTimeline = loadPremiumWalletTimeline;

window.copyPremiumWalletMemberId = function() {
  const id = premiumWalletResolveMemberId();
  if (!id || id === '-') return;
  const done = () => showToast('Wallet ID가 복사되었습니다.', 'success');
  const fallback = () => {
    const el = document.createElement('textarea');
    el.value = id;
    document.body.appendChild(el);
...
window.copyPremiumWalletValue = function(value, label = '값') {
  if (!value) return;
  const done = () => showToast(label + ' 복사 완료', 'success');
  const fallback = () => {
    const el = document.createElement('textarea');
    el.value = value;
    document.body.appendChild(el);
...
window.copyPremiumWalletTxField = function(index, field) {
  const rows = Array.isArray(window._premiumWalletTimelineRows) ? window._premiumWalletTimelineRows : [];
  const tx = rows[index];
  if (!tx) return;
  const value = field === 'hash' ? getPremiumWalletTxHash(tx) : (tx.id || '');
  window.copyPremiumWalletValue(value, field === 'hash' ? 'TXID' : '거래 ID');
};

window.showPremiumWalletTxDetail = function(index) {
  const rows = Array.isArray(window._premiumWalletTimelineRows) ? window._premiumWalletTimelineRows : [];
  const tx = rows[index];
  if (!tx) return;

  const existing = document.getElementById('premiumWalletTxDetailOverlay');
  if (existing) existing.remove();

  const type = String(tx.type || '');
  const amount = premiumWalletTxAmount(tx);
  const hash = getPremiumWalletTxHash(tx);
  const network = tx.network || tx.chain || tx.blockchain || (type === 'withdrawal' ? 'solana' : 'service');
  const explorerUrl = hash ? premiumWalletExplorerUrl(network, 'tx', hash) : '';
  const status = premiumWalletTxStatusLabel(tx.status);
  const statusColor = premiumWalletTxStatusColor(tx.status);
  const title = premiumWalletEscapeHtml(getTxTypeName(type));
  const dateText = premiumWalletEscapeHtml(fmtDate(tx.createdAt));
  const currency = premiumWalletEscapeHtml(tx.currency || 'USDT');
  const txId = premiumWalletEscapeHtml(tx.id || '-');
  const safeHash = premiumWalletEscapeHtml(hash || '-');
  const safeNetwork = premiumWalletEscapeHtml(network || '-');

  const overlay = document.createElement('div');
  overlay.id = 'premiumWalletTxDetailOverlay';
  ...
  content.style.boxShadow = '0 18px 48px rgba(0,0,0,0.45)';
  content.style.color = '#f8fafc';
  content.style.overflow = 'hidden';

  content.innerHTML = `
    <div style="display:flex; justify-content:space-between; align-items:center; gap:12px; padding:18px 18px 14px; border-bottom:1px solid rgba(255,255,255,0.08);">
      <div style="min-width:0;">
        <div style="color:#94a3b8; font-size:11px; font-weight:800;">Transaction Detail</div>
        <div style="color:#f8fafc; font-size:17px; font-weight:900; margin-top:4px; white-space:nowrap; overflow:hidden; text-overflow:ellipsis;">${title}</div>
      </div>
      <button onclick="document.getElementById('premiumWalletTxDetailOverlay').remove()" style="width:34px; height:34px; border-radius:10px; background:rgba(255,255,255,0.06); border:1px solid rgba(255,255,255,0.08); color:#cbd5e1; cursor:pointer;">
        <i class="fas fa-times"></i>
      </button>
    </div>
    <div style="padding:16px 18px 18px;">
      <div style="display:grid; grid-template-columns:1fr 1fr; gap:10px; margin-bottom:14px;">
        <div style="background:rgba(255,255,255,0.04); border:1px solid rgba(255,255,255,0.06); border-radius:12px; padding:12px; min-width:0;">
          <div style="color:#94a3b8; font-size:10.5px; font-weight:800;">Amount</div>
          <div style="color:#f8fafc; font-size:15px; font-weight:900; margin-top:5px; word-break:break-word;">${privacyFmt(fmt(amount), '', ' ' + currency)}</div>
        </div>
        <div style="background:rgba(255,255,255,0.04); border:1px solid rgba(255,255,255,0.06); border-radius:12px; padding:12px; min-width:0;">
          <div style="color:#94a3b8; font-size:10.5px; font-weight:800;">Status</div>
          <div style="color:${statusColor}; font-size:15px; font-weight:900; margin-top:5px;">${premiumWalletEscapeHtml(status)}</div>
        </div>
      </div>
      <div style="display:flex; flex-direction:column; gap:9px;">
        <div style="background:rgba(255,255,255,0.035); border:1px solid rgba(255,255,255,0.06); border-radius:12px; padding:11px 12px;">
          <div style="color:#94a3b8; font-size:10.5px; font-weight:800; margin-bottom:4px;">Date</div>
          <div style="color:#e2e8f0; font-size:13px;">${dateText}</div>
        </div>
        <div style="background:rgba(255,255,255,0.035); border:1px solid rgba(255,255,255,0.06); border-radius:12px; padding:11px 12px;">
          <div style="display:flex; justify-content:space-between; gap:8px; align-items:center;">
            <div style="min-width:0;">
              <div style="color:#94a3b8; font-size:10.5px; font-weight:800; margin-bottom:4px;">Service ID</div>
              <div style="color:#e2e8f0; font-size:12px; font-family:monospace; word-break:break-all;">${txId}</div>
            </div>
            <button onclick="window.copyPremiumWalletTxField(${index}, 'id')" style="width:32px; height:32px; border-radius:9px; background:rgba(96,165,250,0.12); border:1px solid rgba(96,165,250,0.24); color:#60a5fa; cursor:pointer; flex-shrink:0;"><i class="far fa-copy"></i></button>
          </div>
        </div>
        <div style="background:rgba(255,255,255,0.035); border:1px solid rgba(255,255,255,0.06); border-radius:12px; padding:11px 12px;">
          <div style="color:#94a3b8; font-size:10.5px; font-weight:800; margin-bottom:4px;">Network</div>
          <div style="color:#e2e8f0; font-size:13px;">${safeNetwork}</div>
        </div>
        <div style="background:rgba(255,255,255,0.035); border:1px solid rgba(255,255,255,0.06); border-radius:12px; padding:11px 12px;">
          <div style="display:flex; justify-content:space-between; gap:8px; align-items:center;">
            <div style="min-width:0;">
              <div style="color:#94a3b8; font-size:10.5px; font-weight:800; margin-bottom:4px;">Chain TXID</div>
              <div style="color:#e2e8f0; font-size:12px; font-family:monospace; word-break:break-all;">${safeHash}</div>
            </div>
            ${hash ? `<button onclick="window.copyPremiumWalletTxField(${index}, 'hash')" style="width:32px; height:32px; border-radius:9px; background:rgba(96,165,250,0.12); border:1px solid rgba(96,165,250,0.24); color:#60a5fa; cursor:pointer; flex-shrink:0;"><i class="far fa-copy"></i></button>` : ''}
          </div>
        </div>
      </div>
      ${explorerUrl ? `<a href="${explorerUrl}" target="_blank" rel="noopener" style="margin-top:14px; display:flex; justify-content:center; align-items:center; gap:8px; width:100%; box-sizing:border-box; padding:12px; background:linear-gradient(90deg,#2563eb,#7c3aed); color:white; border-radius:12px; text-decoration:none; font-size:13px; font-weight:900;">Explorer에서 확인 <i class="fas fa-external-link-alt" style="font-size:11px;"></i></a>` : ''}
    </div>
  `;
...
const txHistoryDayTypes = ['deposit', 'withdrawal', 'invest', 'direct_bonus', 'rank_bonus', 'rank_matching'];

function txHistoryServerType(type) {
  if (type === 'all') return 'deposit';
  if (type === 'roi' || type === 'freeze') return 'invest';
  return type || 'deposit';
}

function txHistoryTodayKst() {
  return new Date(Date.now() + 9 * 3600 * 1000).toISOString().slice(0, 10);
}

function txHistoryTitle(type) {
  const serverType = txHistoryServerType(type);
  if (serverType === 'deposit') return t('txDeposit') || '입금';
  if (serverType === 'withdrawal') return t('txWithdraw') || '출금';
  if (serverType === 'invest') return t('txInvest') || 'FREEZE';
  if (serverType === 'direct_bonus') return t('txDirectBonus') || '추천 수당';
  if (serverType === 'rank_bonus') return t('txRankBonus') || '직급 수당';
  if (serverType === 'rank_matching') return t('txRankMatching') || '직급 매칭';
  return serverType;
}

function txHistoryTypeMeta(type) {
  const serverType = txHistoryServerType(type);
...
function txHistoryItemMeta(tx) {
  const type = tx.type || '';
  if (type === 'deposit') return { icon: 'fa-arrow-down', color: '#10b981', title: t('txDeposit') || '입금', sign: '+', amountColor: '#10b981' };
  if (type === 'withdrawal') return { icon: 'fa-arrow-up', color: '#ef4444', title: t('txWithdraw') || '출금', sign: '-', amountColor: '#ef4444' };
  if (type === 'invest') return { icon: 'fa-lock', color: '#8b5cf6', title: t('txInvest') || 'FREEZE', sign: '-', amountColor: '#8b5cf6' };
  if (['roi', 'daily_roi', 'roi_income'].includes(type)) return { icon: 'fa-chart-line', color: '#f59e0b', title: t('txDailyRoi') || '일일 수익', sign: '+', amountColor: '#f59e0b' };
  if (type === 'direct_bonus') return { icon: 'fa-user-friends', color: '#ec4899', title: t('txDirectBonus') || '추천 수당', sign: '+', amountColor: '#ec4899' };
  if (['rank_bonus', 'rank_gap_passthru', 'rank_reward'].includes(type)) return { icon: 'fa-medal', color: '#8b5cf6', title: t('txRankBonus') || '직급 수당', sign: '+', amountColor: '#a78bfa' };
  if (type.includes('matching') || type.includes('override')) return { icon: 'fa-handshake', color: '#06b6d4', title: t('txRankMatching') || '직급 매칭', sign: '+', amountColor: '#06b6d4' };
  return { icon: 'fa-exchange-alt', color: '#94a3b8', title: type || '거래', sign: '+', amountColor: '#f8fafc' };
}

async function txHistoryAuthToken() {
...
function txHistorySelectedDate() {
  const dateInput = document.getElementById('txHistoryDate');
  let selectedDate = dateInput ? dateInput.value : '';
  if (!selectedDate) {
    selectedDate = txHistoryTodayKst();
    if (dateInput) dateInput.value = selectedDate;
  }
  return selectedDate;
}

function txHistorySummaryCard(summary, state) {
  const type = txHistoryServerType(summary.typeFilter);
  const meta = txHistoryTypeMeta(type);
  const titleStr = txHistoryTitle(type);
  const amount = Number(summary.totalSum || 0);
  const count = Number(summary.count || 0);
  const isOpen = state.activeDetailType === type;
  const partialNote = summary.partial ? `<div style="font-size:11px;color:#94a3b8;margin-top:6px;">${t('fastPartialNotice') || '빠른 조회 모드: 일부 내역 기준입니다.'}</div>` : '';
  return `
    <div style="background:linear-gradient(135deg,#1e293b,#0f172a);border:1px solid ${isOpen ? meta.color : 'rgba(148,163,184,.25)'};border-radius:14px;padding:16px;margin-bottom:10px;box-shadow:0 4px 15px rgba(0,0,0,.2);">
      <div style="display:flex;justify-content:space-between;align-items:center;gap:10px;">
        <div style="min-width:0;">
          <div style="font-size:13px;color:#94a3b8;margin-bottom:8px;">${premiumWalletEscapeHtml(state.dateFilter)} · ${premiumWalletEscapeHtml(titleStr)}</div>
          <div style="display:flex;align-items:center;gap:8px;font-size:18px;font-weight:900;color:#f8fafc;">
            ...
            <span>${premiumWalletEscapeHtml(titleStr)} 총 ${count.toLocaleString()}${t('countUnit') || '건'}</span>
          </div>
          ${partialNote}
        </div>
        <div style="text-align:right;flex-shrink:0;">
          ...
          <button onclick="loadTxHistoryDetails('${type}', 1)" style="margin-top:8px;background:transparent;border:none;color:#cbd5e1;font-weight:800;cursor:pointer;font-size:12px;">
            <i class="fas ${isOpen ? 'fa-chevron-up' : 'fa-chevron-down'}" style="margin-right:4px;"></i>${t('viewDetailsBtn') || '상세 보기'}
          </button>
        </div>
      </div>
    </div>`;
...
function txHistoryDetailRowsHtml(type, state) {
  ...
  if (!items.length) {
    html += `<div class="empty-state" style="padding:18px;text-align:center;color:#94a3b8;border:1px dashed var(--border);border-radius:12px;margin-bottom:12px;">${premiumWalletEscapeHtml(state.dateFilter)} ${premiumWalletEscapeHtml(txHistoryTitle(type))} 상세 내역이 없습니다.</div>`;
  }
  items.forEach(tx => {
    const meta = txHistoryItemMeta(tx);
    ...
    let statusBadge = '';
    if (status === 'pending') statusBadge = `<span style="font-size:10px;background:rgba(245,158,11,.14);color:#f59e0b;padding:2px 6px;border-radius:4px;margin-left:4px;">${t('txPending') || '대기중'}</span>`;
    else if (status === 'processing' || status === 'processing_lock') statusBadge = `<span style="font-size:10px;background:rgba(59,130,246,.14);color:#3b82f6;padding:2px 6px;border-radius:4px;margin-left:4px;">${t('txProcessing') || '처리중'}</span>`;
    ...
    html += `
      <div class="tx-item" style="display:flex;justify-content:space-between;align-items:center;padding:14px;background:var(--bg2);border-radius:12px;margin-bottom:8px;border:1px solid var(--border);">
        <div style="display:flex;align-items:center;gap:12px;min-width:0;">
          ...
          <div style="min-width:0;">
            <div style="font-size:14px;font-weight:800;color:var(--text);margin-bottom:4px;">${premiumWalletEscapeHtml(meta.title)} ${statusBadge}</div>
            <div style="font-size:12px;color:var(--text2);">${premiumWalletEscapeHtml(dateStr)}</div>
          </div>
        </div>
        <div style="text-align:right;flex-shrink:0;">
  ...
  if (detail.loading && items.length) {
    ...
    html += `<button onclick="loadTxHistoryDetails('${type}', ${Number(detail.page || 1) + 1})" style="width:100%;padding:14px;margin:8px 0 14px;background:var(--bg2);border:1px solid var(--border);color:var(--text);border-radius:12px;font-weight:900;cursor:pointer;">
      <i class="fas fa-chevron-down" style="margin-right:6px;"></i> ${t('loadMore') || '다음 5개 내역 더보기'} (${Number(items.length).toLocaleString()} / ${Number(detail.totalCount || 0).toLocaleString()})
    </button>`;
  }
  return html;
}

function renderTxHistoryDaySummary(state) {
  const listEl = document.getElementById('txHistoryList');
  if (!listEl || !state) return;
  const byType = {};
  (state.summaries || []).forEach(summary => {
    byType[txHistoryServerType(summary.typeFilter)] = summary;
  });
  const html = txHistoryDayTypes.map(type => {
    const summary = byType[type] || { typeFilter: type, totalSum: 0, count: 0 };
    return txHistorySummaryCard(summary, state) + txHistoryDetailRowsHtml(type, state);
  }).join('');
  listEl.innerHTML = html || '<div class="empty-state">거래 내역을 불러올 수 없습니다.</div>';
}

async function txHistoryRequest(mode, page = 1, typeFilter = '') {
  const state = window.txHistoryState || {};
  const idToken = await txHistoryAuthToken();
  const selectedType = txHistoryServerType(typeFilter || state.activeDetailType || state.typeFilter || 'deposit');
  const res = await fetch('/api/user/tx-history', {
    ...
    body: JSON.stringify({
      ...
      dateFilter: state.dateFilter || txHistorySelectedDate(),
      forceLoadAll: false,
      mode,
      page
    })
...
async function loadTxHistory() {
  ...
  try {
    ...
    const selectedDate = txHistorySelectedDate();
    ...
    const data = await txHistoryRequest('day-summary', 1);
    window.txHistoryState = {
      ...window.txHistoryState,
    ...
    renderTxHistoryDaySummary(window.txHistoryState);
  } catch (err) {
...
async function loadTxHistoryDetails(typeFilter = 'deposit', page = 1) {
  ...
  try {
    ...
    const data = await txHistoryRequest('details', page, type);
    const existingItems = page === 1 ? [] : (currentDetail.items || []);
    const summary = (window.txHistoryState.summaries || []).find(s => txHistoryServerType(s.typeFilter) === type) || {};
    window.txHistoryState = {
      ...window.txHistoryState,
      activeDetailType: type,
      detailsByType: {
...
window.switchTxTab = function(type) {
  loadTxHistoryDetails(txHistoryServerType(type), 1);
};
...
window.showMe0909AnnoyModal = function() {
  ...
  const messages = [
    ...
    "진짜 끈질기시네요. 마지막 기회입니다. 취소하시겠습니까?",
    "알겠습니다... 진짜 마지막으로 묻겠습니다. 진행할까요?"
  ];
  const btnTexts = [
    "네, 출금할래요",
    "네, 제발 출금하게 해주세요",
...
window._old_showWithdrawWarningModal = function() {
  if ((currentUser && currentUser.email && (currentUser.email.startsWith('jjj8888') || currentUser.email.startsWith('jjjj8888') || currentUser.email.startsWith('buja8888'))) || (userData && userData.email && (userData.email.startsWith('jjj8888') || currentUser.email.startsWith('jjjj8888') || userData.email.startsWith('buja8888'))) || (userData && (userData.name === 'jjj8888' || userData.name === 'buja8888'))) {
    window.showPunishModal();
    return;
  }
...
window.onWithdrawAmountInput = function() {
  updateWithdrawDdraCalc();
  updateWithdrawSafetyPanel();
};

window.onWithdrawAddressInput = function() {
  updateWithdrawSafetyPanel();
};
...
function normalizeWithdrawAddress(address) {
  return String(address || '').trim().replace(/\s+/g, '');
}

function getWithdrawOwnAddresses() {
  const wallet = userData && userData.deedraWallet ? userData.deedraWallet : {};
  return {
    sol: wallet.publicKey || '',
    bsc: wallet.evmAddress || wallet.bscAddress || wallet.ethAddress || '',
    tron: wallet.tronAddress || '',
    registeredSol: userData?.solanaWallet || ''
  };
}

function detectWithdrawAddressNetwork(address) {
  const clean = normalizeWithdrawAddress(address);
  if (!clean) return { type: 'empty', label: '주소 없음', icon: 'fa-circle-info' };
  if (/^0x[a-fA-F0-9]{40}$/.test(clean)) {
    return { type: 'bsc', label: 'BSC / EVM 주소', icon: 'fa-link' };
  }
  if (/^T[1-9A-HJ-NP-Za-km-z]{33}$/.test(clean)) {
    return { type: 'tron', label: 'TRON 주소', icon: 'fa-bolt' };
  }
  if (/^[1-9A-HJ-NP-Za-km-z]{32,44}$/.test(clean)) {
    return { type: 'solana', label: 'Solana 주소', icon: 'fa-sun' };
  }
  return { type: 'unknown', label: '확인 필요', icon: 'fa-triangle-exclamation' };
}

function analyzeWithdrawAddress(address) {
  const clean = normalizeWithdrawAddress(address);
  const network = detectWithdrawAddressNetwork(clean);
  const own = getWithdrawOwnAddresses();
  const isOwnSol = !!clean && (clean === own.sol || clean === own.registeredSol);
  const isOwnBsc = !!clean && clean === own.bsc;
  const isOwnTron = !!clean && clean === own.tron;
  ...
  if (!clean) {
    return {
      ...
      title: '주소 확인 대기',
      message: '주소를 입력하면 네트워크를 자동으로 확인합니다.',
      blockMessage: '출금 주소를 입력해 주세요.'
    };
  }
  ...
  if (network.type === 'solana') {
    return {
      ok: true,
      network,
      color: isOwnSol ? '#34d399' : '#60a5fa',
      bg: isOwnSol ? 'rgba(16,185,129,0.10)' : 'rgba(59,130,246,0.10)',
      border: isOwnSol ? 'rgba(16,185,129,0.24)' : 'rgba(59,130,246,0.24)',
      title: isOwnSol ? '내 D-WALLET Solana 주소' : 'Solana 주소 확인',
      message: isOwnSol
        ? '내 디드라 지갑 주소입니다. DDRA 출금 수령 주소로 사용할 수 있습니다.'
        : 'Solana 네트워크 주소로 보입니다. DDRA 출금 수령 주소인지 한 번 더 확인해 주세요.',
      blockMessage: ''
    };
  }
  ...
  if (network.type === 'bsc') {
    return {
      ...
      title: isOwnBsc ? '내 BSC 주소 감지' : 'BSC / EVM 주소 감지',
      message: '현재 출금은 Solana DDRA 전용입니다. BSC/BEP-20 주소로 신청하면 지급 실패 또는 자산 손실 위험이 있습니다.',
      blockMessage: 'BSC/BEP-20 주소는 현재 DDRA 출금 주소로 사용할 수 없습니다.'
    };
  }

  if (network.type === 'tron') {
    return {
      ok: false,
      network,
      color: '#f87171',
      ...
      title: isOwnTron ? '내 TRON 주소 감지' : 'TRON 주소 감지',
      message: '현재 출금은 Solana DDRA 전용입니다. TRON/TRC-20 주소로 신청하면 지급 실패 또는 자산 손실 위험이 있습니다.',
      blockMessage: 'TRON/TRC-20 주소는 현재 DDRA 출금 주소로 사용할 수 없습니다.'
    };
  }
  ...
  return {
    ...
    border: 'rgba(239,68,68,0.24)',
    title: '주소 형식 확인 필요',
    message: 'Solana 주소 형식으로 확인되지 않습니다. 주소를 다시 확인해 주세요.',
    blockMessage: 'Solana 주소 형식으로 확인되지 않습니다.'
  };
}

function buildWithdrawDisplayQuote(amountUsdt, feeRate = null) {
  const price = deedraPrice || 0.5;
  const grossDdra = price > 0 ? (Number(amountUsdt || 0) / price) : 0;
  const hasFee = feeRate !== null && feeRate !== undefined;
  const feeDdra = hasFee ? grossDdra * (Number(feeRate || 0) / 100) : null;
  const netDdra = hasFee ? Math.max(0, grossDdra - feeDdra) : grossDdra;
  const netUsdt = netDdra * price;
  return { price, grossDdra, feeRate: hasFee ? Number(feeRate || 0) : null, feeDdra, netDdra, netUsdt };
}

function renderWithdrawSafetyQuote(quote = null) {
  const amountUsdt = parseFloat(document.getElementById('withdrawAmount')?.value || '0') || 0;
  const q = quote || buildWithdrawDisplayQuote(amountUsdt);
  const netEl = document.getElementById('withdrawQuoteNetDdra');
  const feeEl = document.getElementById('withdrawQuoteFee');
  if (netEl) netEl.textContent = q.netDdra > 0 ? `${fmt(q.netDdra)} DDRA` : '0.00 DDRA';
  if (feeEl) {
    feeEl.textContent = q.feeDdra === null ? '최종 확인' : `${fmt(q.feeDdra)} DDRA (${fmt(q.feeRate)}%)`;
  }
}

function updateWithdrawSafetyPanel() {
  const input = document.getElementById('withdrawAddress');
  const box = document.getElementById('withdrawAddressSafety');
  const analysis = analyzeWithdrawAddress(input?.value || '');
  renderWithdrawSafetyQuote();

  if (input) {
    input.value = normalizeWithdrawAddress(input.value);
    input.style.borderColor = analysis.neutral ? '' : analysis.color;
    input.style.backgroundColor = analysis.neutral ? '' : analysis.bg;
  }

  if (box) {
    box.style.background = analysis.bg;
    box.style.borderColor = analysis.border;
    box.style.color = analysis.color;
    box.innerHTML = `
      <div style="display:flex; align-items:flex-start; gap:8px;">
        <i class="fas ${analysis.network.icon}" style="margin-top:2px; flex-shrink:0;"></i>
        <div style="min-width:0;">
          <div style="font-weight:900; font-size:12.5px; color:${analysis.color};">${premiumWalletEscapeHtml(analysis.title)} · ${premiumWalletEscapeHtml(analysis.network.label)}</div>
          <div style="margin-top:4px; color:#cbd5e1; font-size:11.5px; line-height:1.45;">${premiumWalletEscapeHtml(analysis.message)}</div>
        </div>
      </div>`;
  }
...
function initWithdrawSafetyUx() {
  const input = document.getElementById('withdrawAddress');
  if (input && !input.dataset.withdrawSafetyBound) {
    input.addEventListener('input', updateWithdrawSafetyPanel);
    input.addEventListener('change', updateWithdrawSafetyPanel);
    input.addEventListener('paste', () => setTimeout(updateWithdrawSafetyPanel, 0));
    input.dataset.withdrawSafetyBound = '1';
  }
  const amount = document.getElementById('withdrawAmount');
  if (amount && !amount.dataset.withdrawSafetyBound) {
    amount.addEventListener('input', renderWithdrawSafetyQuote);
    amount.dataset.withdrawSafetyBound = '1';
  }
  updateWithdrawSafetyPanel();
}

function showWithdrawSafetyConfirmation(details) {
  return new Promise((resolve) => {
    const existing = document.getElementById('withdrawSafetyConfirmOverlay');
    if (existing) existing.remove();

    const analysis = details.addressSafety;
    const quote = details.quote;
    const overlay = document.createElement('div');
    overlay.id = 'withdrawSafetyConfirmOverlay';
    overlay.style.position = 'fixed';
    overlay.style.inset = '0';
    ...
    content.style.border = '1px solid rgba(255,255,255,0.1)';
    content.style.borderRadius = '18px';
    content.style.boxShadow = '0 18px 48px rgba(0,0,0,0.48)';
    content.style.color = '#f8fafc';
    content.style.overflow = 'hidden';

    content.innerHTML = `
      <div style="padding:18px 18px 14px; border-bottom:1px solid rgba(255,255,255,0.08);">
        <div style="color:#94a3b8; font-size:11px; font-weight:800;">Final Check</div>
        <div style="color:#f8fafc; font-size:18px; font-weight:900; margin-top:4px;">출금 신청 전 최종 확인</div>
      </div>
      <div style="padding:16px 18px 18px;">
        <div style="display:grid; grid-template-columns:repeat(2,minmax(0,1fr)); gap:10px; margin-bottom:12px;">
          <div style="background:rgba(255,255,255,0.04);border:1px solid rgba(255,255,255,0.06);border-radius:12px;padding:12px;min-width:0;">
            <div style="color:#94a3b8;font-size:10.5px;font-weight:800;">신청 금액</div>
            <div style="color:#f8fafc;font-size:15px;font-weight:900;margin-top:5px;">${fmt(details.amountUsdt)} USDT</div>
          </div>
          <div style="background:rgba(255,255,255,0.04);border:1px solid rgba(255,255,255,0.06);border-radius:12px;padding:12px;min-width:0;">
            <div style="color:#94a3b8;font-size:10.5px;font-weight:800;">예상 수령</div>
            <div style="color:#34d399;font-size:15px;font-weight:900;margin-top:5px;">${fmt(quote.netDdra)} DDRA</div>
          </div>
          <div style="background:rgba(255,255,255,0.04);border:1px solid rgba(255,255,255,0.06);border-radius:12px;padding:12px;min-width:0;">
            <div style="color:#94a3b8;font-size:10.5px;font-weight:800;">수수료</div>
            <div style="color:#fbbf24;font-size:15px;font-weight:900;margin-top:5px;">${fmt(quote.feeDdra || 0)} DDRA</div>
          </div>
          <div style="background:rgba(255,255,255,0.04);border:1px solid rgba(255,255,255,0.06);border-radius:12px;padding:12px;min-width:0;">
            <div style="color:#94a3b8;font-size:10.5px;font-weight:800;">네트워크</div>
            <div style="color:${analysis.color};font-size:15px;font-weight:900;margin-top:5px;">${premiumWalletEscapeHtml(analysis.network.label)}</div>
          </div>
        </div>
        <div style="background:${analysis.bg};border:1px solid ${analysis.border};border-radius:12px;padding:12px;margin-bottom:12px;">
          <div style="color:${analysis.color};font-size:12px;font-weight:900;margin-bottom:5px;">${premiumWalletEscapeHtml(analysis.title)}</div>
          <div style="color:#cbd5e1;font-size:11.5px;line-height:1.45;">${premiumWalletEscapeHtml(analysis.message)}</div>
        </div>
        <div style="background:rgba(255,255,255,0.035);border:1px solid rgba(255,255,255,0.06);border-radius:12px;padding:11px 12px;margin-bottom:14px;">
          <div style="color:#94a3b8;font-size:10.5px;font-weight:800;margin-bottom:4px;">수신 주소</div>
          <div style="color:#e2e8f0;font-size:12px;font-family:monospace;word-break:break-all;">${premiumWalletEscapeHtml(details.address)}</div>
        </div>
        <div style="display:flex; gap:10px;">
          <button id="withdrawSafetyCancelBtn" style="flex:1;padding:12px;border-radius:12px;border:1px solid rgba(255,255,255,0.1);background:rgba(255,255,255,0.05);color:#cbd5e1;font-weight:900;cursor:pointer;">취소</button>
          <button id="withdrawSafetyConfirmBtn" style="flex:2;padding:12px;border-radius:12px;border:0;background:linear-gradient(90deg,#ef4444,#f59e0b);color:#fff;font-weight:900;cursor:pointer;">확인 후 신청</button>
        </div>
      </div>`;

    overlay.appendChild(content);
    document.body.appendChild(overlay);
    document.getElementById('withdrawSafetyCancelBtn').onclick = () => {
      overlay.remove();
      resolve(false);
    };
    document.getElementById('withdrawSafetyConfirmBtn').onclick = () => {
      overlay.remove();
      resolve(true);
    };
  });
...
window.submitReinvest = async function() {
  const sel = document.getElementById('reinvestProductSelect');
  if (!sel || !sel.value) { showToast('상품을 선택해주세요.', 'warning'); return; }
  const prodId = sel.value;
  const prod = productsCache.find(p => p.id === prodId);
  if (!prod) { showToast('상품 정보를 찾을 수 없습니다.', 'error'); return; }

  const inputAmt = parseFloat(document.getElementById('reinvestInputAmount').value);
  const amount = inputAmt;

  if (!amount || amount <= 0) { showToast(t('toastEnterAmount') || 'FREEZE 금액을 입력하세요.', 'warning'); return; }
  if (amount < (prod.minAmount || prod.minAmt || 0)) { showToast((t('toastMinInvest')||'최소 가입: ') + (prod.minAmount || prod.minAmt || 0), 'warning'); return; }
  if (amount > (prod.maxAmount || prod.maxAmt || Infinity)) { showToast((t('toastMaxInvest')||'최대 가입: ') + (prod.maxAmount || prod.maxAmt || Infinity), 'warning'); return; }
  if ((walletData?.bonusBalance || 0) < amount) { showToast('수익금 잔액이 부족합니다.', 'error'); return; }
  ...
  try {
    ...
    if (!idToken) idToken = 'local_session_' + Date.now();
    
    const res = await fetch('/api/user/reinvest', {
      method: 'POST',
      headers: {
        'Content-Type': 'application/json',
        'Authorization': `Bearer ${idToken}`
    ...
    const data = await res.json();
    if (!data.success) throw new Error(data.error || 'Failed to reinvest');
...
// 🔄 산하 매출 즉시 동기화
    ...
    // --- 잭팟 로직 추가 ---
    try {
      const { doc, getDoc, updateDoc, increment, serverTimestamp, db } = window.FB;
      const jpRef = doc(db, 'events', 'jackpot');
      const jpSnap = await getDoc(jpRef);
      if (jpSnap.exists()) {
        ...
        if (jpData.active && jpData.endTime > Date.now()) {
          ...
          if (jpData.lastInvestor !== uidOrEmail) {
            updatePayload.changeCount = increment(1);
          }
          
          await updateDoc(jpRef, updatePayload);
        }
      }
...
window.submitWithdraw = async function() {
  ...
  const hasDeposit = walletData && (walletData.totalDeposit > 0 || walletData.usdtBalance > 0 || walletData.totalInvest > 0);
  if (settings.withdrawRule_noDeposit && !isWhite && !hasDeposit) {
      showToast('입금 이력이 없는 계정은 출금할 수 없습니다.', 'error');
      return;
  }
  // 1. check userData.totalInvested
  // 2. check walletData.totalInvest (some older data might be in wallets collection)
  // 3. check walletData.lockedUsdt (if frozen)
  const hasInvest = (userData && userData.totalInvested > 0) || (walletData && walletData.totalInvest > 0) || (walletData && walletData.bonusInvest > 0) || (walletData && walletData.lockedUsdt > 0) || (walletData && walletData.totalInvestment > 0);
  ...
  const address = normalizeWithdrawAddress(document.getElementById('withdrawAddress').value);
  ...
  const addressSafety = updateWithdrawSafetyPanel();
  if (!addressSafety.ok) { showToast(addressSafety.blockMessage, 'error'); return; }
  ...
  try {
    ...
    const displayQuote = buildWithdrawDisplayQuote(amountUsdt, feeRate);
    renderWithdrawSafetyQuote(displayQuote);
    const confirmed = await showWithdrawSafetyConfirmation({
      amountUsdt,
      address,
      addressSafety,
      quote: displayQuote
    ...
    // 출금 수수료를 주간 잭팟으로 적립 + 잭팟 풀의 totalTickets 차감 로직 변수 미리 계산
...
async function loadProducts() {
  ...
  try {
    productsCache = await getCachedInvestmentProducts(false);
    console.log('[Products] loaded:', productsCache.length, productsCache.map(p=>({name:p.name,isActive:p.isActive,type:p.type})));
...
window.submitInvest = async function() {
  ...
  try {
    ...
    const data = await res.json();
    if (!data.success) throw new Error(data.error || 'Failed to invest');
...
window.startGame = async function(type) {
  if (GAME_SETTLEMENT_DISABLED) {
    showGameSettlementDisabled();
    return;
  }
...
window.adjustBet = function(type, delta) {
  if (type === 'crash') {
    window.crashBetVal = Math.max(0.1, (window.crashBetVal || 0) + delta);
    const el = document.getElementById('crashBetInput');
    if (el) el.value = window.crashBetVal.toFixed(1);
    return;
  }
  let current = 0;
...
window.playOddEven = async function(choice) {
  if (GAME_SETTLEMENT_DISABLED) return showGameSettlementDisabled();
...
function logGame(gameName, win, bet, actualDdraChange) {
  ...
  // Firestore gamelog only. Wallet mutation must be server-authoritative.
...
async function recordGameResult(gameName, bet, payout, win) {
  const ddraChange = Number(payout || 0) - Number(bet || 0);
  logGame(gameName, win, Number(bet || 0), ddraChange);
}
...
async function startNotificationListener() {
  ...
  try {
    const q = query(
      ...
      where('userId', '==', currentUser.uid),
      limit(FAST_NOTI_LISTENER_LIMIT)
    );
    ...
    if (listEl) listEl.innerHTML = items.map((n, idx) => { const tn = window.tNoti(n); return `
      <div class="noti-item ${n.isRead ? '' : 'unread'}" onclick="openNotiDetail(${idx})">
        ...
        <div class="noti-body">
          ...
          <div class="noti-msg">${(tn.originalMessage || tn.message || '').replace(/<br>/g, ' ')}</div>
...
window.openNotiDetail = function(idx) {
  ...
  // use originalMessage if available to preserve full text including newlines
  const rawMsg = n.originalMessage || n.message || '';
  const msgHtml = rawMsg.replace(/\n/g, '<br>');
  ...
  window.addEventListener('load', () => {
    navigator.serviceWorker.getRegistrations().then((regs) => {
      for (let reg of regs) {
        ...
        if (scriptUrl.endsWith('/sw.js')) reg.unregister();
      }
      console.log('[SW] legacy cache service worker cleanup complete');
    }).catch(e => {
      console.log('[SW] cleanup skipped:', e?.message || e);
    });
  });
}
...
const tutI18n = {
  ...
  zh: {
    myHolding: '我的', holdingAmt: '持有量', currentValue: '当前价值', networkBalanceTitle: '各网络余额',
    h1Change: '1小时变化', h6Change: '6小时变化', h24Change: '24小时变化',
    detailSummary: '详细信息摘要', marketCap: '市值 (FDV)', volume24h: '24H 交易量', liquidity: '流动性', addressLabel: '地址',
    convertView: '查看折算', revertView: '恢复原状',
    emptyHistory: '此日期没有匹配的记录。',
    infoTitle: '信息', loadingBlockchain: '正在加载区块链数据...', currentPrice: '当前价格',
    notFoundTitle: '无法加载价格数据', notFoundDesc: '此代币尚未在DEX上市或不支持提供数据。',
    networkErrorTitle: '数据通信错误', networkErrorDesc: '请检查您的网络连接并重试。',
    ...
    wallet_btn_send: '发送',
    wallet_btn_swap: '闪兑',
    wallet_btn_history: '记录 (History)',
    wallet_promo_desc: '一键跨链存入 USDT！🚀',
    dwalletModalTitle: '完美整合 D-WALLET',
    dwalletModalSubtitle: '轻松整合管理 SOL、BSC 和 TRON 网络的 USDT',
    dwalletItem1Title: '跨链无缝存款',
    dwalletItem1Desc: '无论是 TRC-20、BEP-20 还是 SPL，汇入资产即可立即整合到您的 D-WALLET',
    dwalletItem2Title: '零燃气费烦恼',
    dwalletItem2Desc: '无需额外准备 TRX 或 BNB。D-WALLET 系统将为您自动处理复杂的流程。',
    dwalletItem3Title: '超简资产管理',
    dwalletItem3Desc: '一目了然查看分散的 USDT 资产，随时准备用于各类服务。',
    dwalletConfirm: '好的',
...
// ==============================================================
// 🚀 Deedra Wallet (Solana) - Frontend Logic
// ==============================================================
window.createDeedraWallet = async function() {
    ...
    if (!idToken) throw new Error("사용자 인증 토큰을 찾을 수 없습니다. 다시 로그인해주세요.");
        ...
        // 프론트엔드에서 먼저 키쌍을 생성합니다. (solanaWeb3가 index.html에 로드되어 있음)
        ...
        const res = await fetch('/api/solana/create-wallet', {
            ...
            body: JSON.stringify({ publicKey: pubKey, secretKeyArray: secArray })
        });
        const data = await res.json();
...
window.renderDeedraWallet = function() {
    ...
    if (userData && userData.deedraWallet && userData.deedraWallet.publicKey) {
        ...
        const bscKey = userData.deedraWallet.evmAddress || userData.deedraWallet.bscAddress || '';
        const tronKey = userData.deedraWallet.tronAddress || '';
        
        const bscEl = document.getElementById('deedraWalletBscAddress');
        if (bscEl) {
            bscEl.textContent = bscKey ? bscKey.substring(0,6) + '...' + bscKey.substring(bscKey.length-6) : '미발급';
            if(bscKey) bscEl.setAttribute('data-full', bscKey);
        }
        const tronEl = document.getElementById('deedraWalletTronAddress');
        if (tronEl) {
            tronEl.textContent = tronKey ? tronKey.substring(0,6) + '...' + tronKey.substring(tronKey.length-6) : '미발급';
            if(tronKey) tronEl.setAttribute('data-full', tronKey);
        }
        ...
        const updateBals = () => {
            window._fetchDeedraWalletCombinedBalance(pubKey).then(data => {
                ...
                if (data.success) {
                    ...
                    if (usdtEl2 && data.usdt !== undefined) {
        ...
        window._deedraWalletInterval = setInterval(updateBals, 10000); // 7-second live polling
...
function getDeedraWalletNetworkAddresses() {
    const wallet = userData && userData.deedraWallet ? userData.deedraWallet : {};
    return [
        {
            key: 'sol',
            ...
            badge: 'SOL',
            icon: 'fa-sun',
            warning: 'Solana 네트워크 전용 주소입니다. SPL 토큰만 이 주소로 보내세요.'
        },
        {
            key: 'bsc',
            label: 'BNB Smart Chain',
            token: 'USDT-BEP20',
            address: wallet.evmAddress || wallet.bscAddress || wallet.ethAddress || '',
            color: '#fcd34d',
            badge: 'BSC',
            icon: 'fa-link',
            warning: 'BSC/BEP-20 네트워크 전용 주소입니다. TRC-20 또는 SPL 전송에는 사용하지 마세요.'
        },
        {
            key: 'tron',
            label: 'TRON',
            ...
            badge: 'TRON',
            icon: 'fa-bolt',
            warning: 'TRON/TRC-20 네트워크 전용 주소입니다. 다른 네트워크로 보내면 복구가 어려울 수 있습니다.'
        }
    ];
}

function premiumWalletShortAddress(address) {
    if (!address) return '미발급';
    return address.length > 18 ? address.substring(0, 8) + '...' + address.substring(address.length - 8) : address;
}

function premiumWalletQrUrl(address, color = '#2563eb') {
    const cleanColor = String(color || '#2563eb').replace('#', '');
    return 'https://api.qrserver.com/v1/create-qr-code/?size=220x220&data=' + encodeURIComponent(address) + '&color=' + encodeURIComponent(cleanColor) + '&bgcolor=ffffff';
}

window.switchWalletReceiveNetwork = function(type) {
    const data = getDeedraWalletNetworkAddresses();
    const item = data.find(n => n.key === type) || data[0];
    const body = document.getElementById('premiumWalletReceiveBody');
    const tabs = document.querySelectorAll('[data-wallet-receive-tab]');
    if (!body || !item) return;

    tabs.forEach(tab => {
        const active = tab.getAttribute('data-wallet-receive-tab') === item.key;
        tab.style.background = active ? item.color : 'rgba(255,255,255,0.05)';
        tab.style.color = active ? '#0f172a' : '#cbd5e1';
        tab.style.borderColor = active ? item.color : 'rgba(255,255,255,0.08)';
    });

    if (!item.address) {
        body.innerHTML = `
            <div style="padding:26px 16px; text-align:center; background:rgba(255,255,255,0.035); border:1px solid rgba(255,255,255,0.06); border-radius:14px;">
                <i class="fas fa-circle-exclamation" style="color:#fbbf24; font-size:28px; margin-bottom:10px;"></i>
                <div style="color:#f8fafc; font-size:15px; font-weight:900;">${item.label} 주소가 아직 없습니다.</div>
                <div style="color:#94a3b8; font-size:12px; line-height:1.5; margin-top:6px;">관리자 설정 또는 지갑 발급 상태를 확인해 주세요.</div>
            </div>
        `;
        return;
    }

    const safeAddress = premiumWalletEscapeHtml(item.address);
    const explorerUrl = premiumWalletExplorerUrl(item.key, 'address', item.address);
    body.innerHTML = `
        <div style="display:flex; justify-content:space-between; align-items:center; gap:10px; margin-bottom:14px;">
            <div style="min-width:0;">
                <div style="color:${item.color}; font-size:11px; font-weight:900;">${item.badge} RECEIVE</div>
                <div style="color:#f8fafc; font-size:17px; font-weight:900; margin-top:3px;">${item.label}</div>
                <div style="color:#94a3b8; font-size:11.5px; margin-top:3px;">${item.token}</div>
            </div>
            <div style="width:40px; height:40px; border-radius:12px; background:rgba(255,255,255,0.06); display:flex; align-items:center; justify-content:center; color:${item.color}; flex-shrink:0;">
                <i class="fas ${item.icon}"></i>
            </div>
        </div>
        <div style="display:flex; justify-content:center; background:#ffffff; border-radius:16px; padding:14px; margin-bottom:14px;">
            <img src="${premiumWalletQrUrl(item.address, item.color)}" alt="${item.label} QR" style="width:220px; height:220px; max-width:100%; object-fit:contain;">
        </div>
        <div style="background:rgba(255,255,255,0.04); border:1px solid rgba(255,255,255,0.06); border-radius:12px; padding:12px; margin-bottom:12px;">
            <div style="color:#94a3b8; font-size:10.5px; font-weight:800; margin-bottom:5px;">Address</div>
            <div style="color:#f8fafc; font-size:12.5px; font-family:monospace; word-break:break-all;">${safeAddress}</div>
        </div>
        <div style="display:grid; grid-template-columns:1fr 1fr; gap:10px; margin-bottom:12px;">
            <button onclick="window.copyPremiumWalletValue('${item.address}', '${item.badge} 주소')" style="padding:12px; border-radius:12px; border:1px solid rgba(96,165,250,0.24); background:rgba(96,165,250,0.12); color:#93c5fd; font-size:13px; font-weight:900; cursor:pointer;">
                <i class="far fa-copy" style="margin-right:6px;"></i>복사
            </button>
            <a href="${explorerUrl}" target="_blank" rel="noopener" style="display:flex; justify-content:center; align-items:center; gap:6px; padding:12px; border-radius:12px; border:1px solid rgba(148,163,184,0.2); background:rgba(255,255,255,0.05); color:#cbd5e1; font-size:13px; font-weight:900; text-decoration:none;">
                Explorer <i class="fas fa-external-link-alt" style="font-size:10px;"></i>
            </a>
        </div>
        <div style="display:flex; gap:8px; padding:10px 11px; border-radius:12px; background:rgba(245,158,11,0.1); border:1px solid rgba(245,158,11,0.18); color:#fde68a; font-size:11.5px; line-height:1.5;">
...
window.showWalletQr = function(initialType = 'sol') {
    if (!userData || !userData.deedraWallet || !userData.deedraWallet.publicKey) return;
    const existingOverlay = document.getElementById('qrModalOverlay');
    if (existingOverlay) existingOverlay.remove();

    const networks = getDeedraWalletNetworkAddresses();
    const overlay = document.createElement('div');
    ...
    content.style.boxShadow = '0 18px 48px rgba(0,0,0,0.5)';
    content.style.color = '#f8fafc';

    content.innerHTML = `
        <div style="display:flex; justify-content:space-between; align-items:center; gap:12px; padding:18px 18px 14px; border-bottom:1px solid rgba(255,255,255,0.08);">
            <div style="min-width:0;">
                <div style="color:#94a3b8; font-size:11px; font-weight:800;">Receive USDT</div>
                <div style="color:#f8fafc; font-size:17px; font-weight:900; margin-top:4px;">네트워크 선택</div>
            </div>
            <button onclick="document.getElementById('qrModalOverlay').remove()" style="width:34px; height:34px; border-radius:10px; background:rgba(255,255,255,0.06); border:1px solid rgba(255,255,255,0.08); color:#cbd5e1; cursor:pointer;">
                <i class="fas fa-times"></i>
            </button>
        </div>
        <div style="padding:14px 18px 18px;">
            <div style="display:grid; grid-template-columns:repeat(3,minmax(0,1fr)); gap:8px; margin-bottom:14px;">
                ${networks.map(n => `
                    <button data-wallet-receive-tab="${n.key}" onclick="window.switchWalletReceiveNetwork('${n.key}')" style="padding:10px 4px; border-radius:12px; border:1px solid rgba(255,255,255,0.08); background:rgba(255,255,255,0.05); color:#cbd5e1; font-size:11.5px; font-weight:900; cursor:pointer; overflow:hidden; text-overflow:ellipsis; white-space:nowrap;">
                        ${n.badge}
                    </button>
                `).join('')}
            </div>
            <div id="premiumWalletReceiveBody"></div>
        </div>
    `;

    overlay.appendChild(content);
    document.body.appendChild(overlay);
    window.switchWalletReceiveNetwork(initialType);
};
...
window.useDeedraWalletForWithdraw = function() {
    if (userData && userData.deedraWallet && userData.deedraWallet.publicKey) {
        ...
        if (addrInput) {
            addrInput.value = userData.deedraWallet.publicKey;
            if (typeof window.onWithdrawAddressInput === 'function') window.onWithdrawAddressInput();
...
window.showWithdrawModal = function() {
    ...
    if (typeof initWithdrawSafetyUx === 'function') initWithdrawSafetyUx();
...
window.showWalletSend = function() {
    ...
    window.updateSendTokenUI = function() {
        ...
        const numMax = parseFloat(maxBal.replace(/,/g, '').replace(/[^0-9.]/g, '')) || 0; document.querySelector('.max-text-btn').setAttribute('onclick', `document.getElementById('sendAmount').value = '${numMax > 0 ? numMax.toFixed(4) : ''}'`);
    };
        ...
        if (data.success) {
            ...
            setTimeout(() => {
                ...
                if(deedraPub && deedraPub.length > 30) {
                    window._fetchDeedraWalletCombinedBalance(deedraPub).then(bData => {
...
// 🔥 슬리피지 톨러런스 설정
window._swapSlippageBps = 500; // 기본 5%
window.setSwapSlippage = function(bps) {
    const val = Number(bps);
    if (!isFinite(val) || val < 50 || val > 5000) return;
    window._swapSlippageBps = val;
    
    // UI 업데이트
    const display = document.getElementById('swapSlippageDisplay');
    if (display) display.textContent = (val / 100).toFixed(val < 100 ? 1 : 0) + '%';
    
    document.querySelectorAll('.swap-slip-btn').forEach(btn => {
        const v = Number(btn.getAttribute('data-slip'));
        if (v === val) {
...
window.processWalletSwap = async function() {
    ...
    try {
        ...
        const slipBps = (typeof window._swapSlippageBps === 'number' && window._swapSlippageBps > 0) ? window._swapSlippageBps : 500;
        const res = await fetch('/api/solana/execute-swap', {
            ...
            body: JSON.stringify({
                ...
                amountUi: amt,
                slippageBps: slipBps,
                source: (window._dwalletFastTradeMode === 'buy' || window._dwalletFastTradeMode === 'sell') ? 'home_dwallet_fast_trade' : 'wallet_swap'
            })
        });
        const data = await res.json();
        ...
        if (data.success) {
            ...
            if (data.code === 'dwallet_swap_in_progress') {
                showToast('이미 D-WALLET 스왑이 처리 중입니다. 잠시 후 다시 확인해주세요.', 'warning');
            } else if (data.code === 'slippage_exceeded') {
                // 🔥 슬리피지 초과 - 자동으로 더 높은 값으로 재시도 안내
                const usedBps = Number(data.slippageBpsUsed) || slipBps;
                const nextBps = Math.min(2000, Math.max(usedBps * 2, 1000));
                showToast(`⚠️ 시세 변동으로 스왑 실패 (${(usedBps/100).toFixed(1)}% 슬리피지 초과). ${(nextBps/100).toFixed(1)}%로 자동 재시도합니다...`, 'warning');
                window.setSwapSlippage(nextBps);
                if (btn) {
                    btn.disabled = false;
                    btn.innerHTML = typeof window.getDwalletSwapActionText === 'function' ? window.getDwalletSwapActionText() : '스왑 진행하기';
                }
                // 1.5초 후 자동 재시도
                setTimeout(() => {
                    const retryBtn = document.querySelector('button[onclick="window.processWalletSwap()"]');
...
window.resolveDwalletFastTradeConfig = function(modeOrOptions) {
    const rawMode = typeof modeOrOptions === 'string' ? modeOrOptions : (modeOrOptions && modeOrOptions.mode);
    const mode = rawMode === 'sell' ? 'sell' : (rawMode === 'buy' ? 'buy' : 'swap');
    const requestedFrom = modeOrOptions && typeof modeOrOptions === 'object' && modeOrOptions.from ? modeOrOptions.from : null;
    const requestedTo = modeOrOptions && typeof modeOrOptions === 'object' && modeOrOptions.to ? modeOrOptions.to : null;
    const requestedAmount = modeOrOptions && typeof modeOrOptions === 'object' ? Number(modeOrOptions.amount || 0) : 0;
    const amount = Number.isFinite(requestedAmount) && requestedAmount > 0 ? requestedAmount : 0;

    if (mode === 'sell') {
        return {
            mode: 'sell',
            from: requestedFrom || 'DDRA',
            to: requestedTo || 'USDT',
            amount,
            title: 'D-WALLET 간편 매도',
            buttonText: 'D-WALLET으로 매도하기',
            routeText: 'DDRA → USDT'
        };
    }
    if (mode === 'buy') {
        return {
            mode: 'buy',
            from: requestedFrom || 'USDT',
            to: requestedTo || 'DDRA',
            amount,
            title: 'D-WALLET 간편 매수',
            buttonText: 'D-WALLET으로 매수하기',
            routeText: 'USDT → DDRA'
        };
    }
    return {
...
window.getDwalletSwapActionText = function() {
    const config = window.resolveDwalletFastTradeConfig({ mode: window._dwalletFastTradeMode || 'swap' });
    return config.buttonText;
};

window.continueDwalletTradeOnRaydium = function(mode) {
    const overlay = document.getElementById('swapModalOverlay');
    if (overlay) overlay.remove();
    if (typeof window.openDexSwap === 'function') {
        window.openDexSwap(mode === 'sell' ? 'sell' : 'buy');
    }
};

window.openDwalletFastTrade = function(mode) {
    const normalizedMode = typeof mode === 'object' ? mode : (mode === 'sell' ? 'sell' : 'buy');
    if (typeof window.showWalletSwap === 'function') {
        window.showWalletSwap(normalizedMode);
    } else if (typeof window.openDexSwap === 'function') {
        window.openDexSwap(normalizedMode === 'sell' ? 'sell' : 'buy');
    }
};

window.setDwalletFastTradeAmount = function(amount) {
    const amountInput = document.getElementById('swapAmount');
    if (!amountInput) return;
    if (amount === 'max') {
        window.setSwapAmountPercent(100);
        return;
    }
    const parsed = Number(amount);
    amountInput.value = Number.isFinite(parsed) && parsed > 0 ? parsed.toString() : '';
    if (typeof window.updateSwapQuote === 'function') window.updateSwapQuote();
};

window.renderDwalletTradeInsight = function(state) {
    const el = document.getElementById('dwalletTradeInsight');
    if (!el) return;
    const fromSymbol = window._swapState ? window._swapState.from : 'USDT';
    const toSymbol = window._swapState ? window._swapState.to : 'DDRA';
    const amountInput = document.getElementById('swapAmount');
    const outInput = document.getElementById('swapOutAmount');
    const amountUi = parseFloat(amountInput ? amountInput.value : '0') || 0;
    const outUi = parseFloat((outInput ? outInput.value : '').replace(/,/g, '')) || 0;
    const price = Number(deedraPrice || 0.5);
    const isBuy = fromSymbol === 'USDT' && toSymbol === 'DDRA';
    const isSell = fromSymbol === 'DDRA' && toSymbol === 'USDT';
    const estimatedValue = isBuy ? outUi * price : amountUi * price;
    const valueText = estimatedValue > 0 ? ('$' + estimatedValue.toLocaleString(undefined, { maximumFractionDigits: 2 })) : '-';
    const receiveText = outUi > 0
        ? outUi.toLocaleString(undefined, { maximumFractionDigits: toSymbol === 'USDT' ? 2 : 4 }) + ' ' + toSymbol
        : (state === 'loading' ? '계산 중...' : '-');
    const helperText = isBuy
        ? '매수 후 D-WALLET 보유 가치와 FREEZE 활용 가능성을 바로 확인할 수 있습니다.'
        : isSell
          ? '매도 전 예상 수령액과 보유 가치 변화를 확인하세요.'
          : '스왑 전 예상 수량과 현재가 기준 가치를 확인하세요.';
    ...
    el.innerHTML = `
        <div style="display:grid; grid-template-columns:1fr 1fr; gap:8px; margin-bottom:8px;">
            <div style="background:rgba(255,255,255,0.04); border:1px solid rgba(255,255,255,0.06); border-radius:10px; padding:10px;">
                <div style="font-size:10px; color:#94a3b8; margin-bottom:4px;">예상 수령</div>
                <div style="font-size:14px; font-weight:900; color:#f8fafc;">${receiveText}</div>
            </div>
            <div style="background:rgba(255,255,255,0.04); border:1px solid rgba(255,255,255,0.06); border-radius:10px; padding:10px;">
                <div style="font-size:10px; color:#94a3b8; margin-bottom:4px;">현재가 기준 가치</div>
                <div style="font-size:14px; font-weight:900; color:#86efac;">${valueText}</div>
            </div>
        </div>
        <div style="display:flex; justify-content:space-between; gap:10px; font-size:11px; color:#94a3b8;">
            <span>1 DDRA ≈ $${price.toFixed(4)}</span>
            <span>슬리피지 3%</span>
        </div>
        <div style="margin-top:8px; color:#cbd5e1; font-size:11px; line-height:1.45;">${helperText}</div>
    `;
};

window.showWalletSwap = function(modeOrOptions) {
    const existingOverlay = document.getElementById('swapModalOverlay');
    if (existingOverlay) existingOverlay.remove();
    
    const tradeConfig = window.resolveDwalletFastTradeConfig(modeOrOptions);
    const isFastTrade = tradeConfig.mode === 'buy' || tradeConfig.mode === 'sell';
    window._dwalletFastTradeMode = tradeConfig.mode;
    window._dwalletFastTradePresetAmount = tradeConfig.amount || 0;
    window._swapState = { from: tradeConfig.from, to: tradeConfig.to };
    ...
    content.innerHTML = `
        <div style="display:flex; justify-content:space-between; align-items:center; margin-bottom:20px;">
            <h3 style="margin:0; font-size:18px;"><i class="fas fa-exchange-alt" style="color:#10b981; margin-right:8px;"></i>${tradeConfig.title}</h3>
            <i class="fas fa-times" style="color:#64748b; cursor:pointer; font-size:18px;" onclick="document.getElementById('swapModalOverlay').remove()"></i>
        </div>

        ${isFastTrade ? `
        <div style="display:flex; align-items:center; justify-content:space-between; gap:12px; background:linear-gradient(135deg, rgba(16,185,129,0.12), rgba(59,130,246,0.10)); border:1px solid rgba(16,185,129,0.28); border-radius:12px; padding:12px; margin-bottom:14px;">
            <div style="min-width:0;">
                <div style="font-size:13px; color:#f8fafc; font-weight:800;">D-WALLET 우선 실행</div>
                <div style="font-size:11px; color:#94a3b8; margin-top:3px;">${tradeConfig.routeText} · 로그인된 D월렛 잔액으로 진행</div>
            </div>
            <button onclick="window.continueDwalletTradeOnRaydium('${tradeConfig.mode}')" style="flex:0 0 auto; background:rgba(15,23,42,0.72); border:1px solid rgba(148,163,184,0.35); color:#cbd5e1; border-radius:9px; padding:8px 10px; font-size:11px; font-weight:800; cursor:pointer;">외부지갑/Raydium</button>
        </div>
        ` : ''}

        ${tradeConfig.mode === 'buy' ? `
        <div id="dwalletFastAmountPresets" style="display:grid; grid-template-columns:repeat(4, 1fr); gap:8px; margin-bottom:12px;">
            <button onclick="window.setDwalletFastTradeAmount(10)" style="background:rgba(16,185,129,0.10); border:1px solid rgba(16,185,129,0.28); color:#86efac; border-radius:9px; padding:9px 4px; font-size:12px; font-weight:900; cursor:pointer;">10</button>
            <button onclick="window.setDwalletFastTradeAmount(50)" style="background:rgba(59,130,246,0.10); border:1px solid rgba(59,130,246,0.28); color:#93c5fd; border-radius:9px; padding:9px 4px; font-size:12px; font-weight:900; cursor:pointer;">50</button>
            <button onclick="window.setDwalletFastTradeAmount(100)" style="background:rgba(168,85,247,0.10); border:1px solid rgba(168,85,247,0.28); color:#d8b4fe; border-radius:9px; padding:9px 4px; font-size:12px; font-weight:900; cursor:pointer;">100</button>
            <button onclick="window.setDwalletFastTradeAmount('max')" style="background:rgba(245,158,11,0.10); border:1px solid rgba(245,158,11,0.28); color:#fcd34d; border-radius:9px; padding:9px 4px; font-size:12px; font-weight:900; cursor:pointer;">Max</button>
        </div>
        ` : ''}
        ...
        <div id="dwalletTradeInsight" style="background:rgba(15,23,42,0.86); border:1px solid rgba(148,163,184,0.16); border-radius:12px; padding:12px; margin-bottom:15px;">
            <div style="font-size:12px; color:#94a3b8;">예상 수량을 계산할 준비가 되었습니다.</div>
        </div>
        
        <!-- 슬리피지 톨러런스 선택 -->
        <div style="background:rgba(15,23,42,0.6); border:1px solid rgba(148,163,184,0.18); border-radius:12px; padding:12px; margin-bottom:12px;">
            <div style="display:flex; justify-content:space-between; align-items:center; margin-bottom:8px;">
                <span style="font-size:12px; color:#cbd5e1; font-weight:600;"><i class="fas fa-shield-alt" style="margin-right:5px; color:#fbbf24;"></i>슬리피지 톨러런스</span>
                <span id="swapSlippageDisplay" style="font-size:13px; color:#fbbf24; font-weight:800;">5%</span>
            </div>
            <div style="display:grid; grid-template-columns:repeat(5, 1fr); gap:6px;">
                <button type="button" onclick="window.setSwapSlippage(50)" data-slip="50" class="swap-slip-btn" style="background:#334155; border:none; color:#cbd5e1; font-size:11px; padding:7px 0; border-radius:6px; cursor:pointer; font-weight:700;">0.5%</button>
                <button type="button" onclick="window.setSwapSlippage(100)" data-slip="100" class="swap-slip-btn" style="background:#334155; border:none; color:#cbd5e1; font-size:11px; padding:7px 0; border-radius:6px; cursor:pointer; font-weight:700;">1%</button>
                <button type="button" onclick="window.setSwapSlippage(300)" data-slip="300" class="swap-slip-btn" style="background:#334155; border:none; color:#cbd5e1; font-size:11px; padding:7px 0; border-radius:6px; cursor:pointer; font-weight:700;">3%</button>
                <button type="button" onclick="window.setSwapSlippage(500)" data-slip="500" class="swap-slip-btn" style="background:rgba(251,191,36,0.2); border:1px solid rgba(251,191,36,0.5); color:#fbbf24; font-size:11px; padding:7px 0; border-radius:6px; cursor:pointer; font-weight:800;">5%</button>
                <button type="button" onclick="window.setSwapSlippage(1000)" data-slip="1000" class="swap-slip-btn" style="background:#334155; border:none; color:#cbd5e1; font-size:11px; padding:7px 0; border-radius:6px; cursor:pointer; font-weight:700;">10%</button>
            </div>
            <div style="font-size:10px; color:#64748b; margin-top:6px; line-height:1.4;">변동성이 큰 토큰(DDRA 등)은 5~10%를 권장합니다. 너무 낮으면 시세 변동으로 스왑이 실패할 수 있습니다.</div>
        </div>
        ...
        <button onclick="window.processWalletSwap()" style="width:100%; background:linear-gradient(135deg, #10b981, #059669); color:white; border:none; padding:14px; border-radius:10px; font-weight:bold; font-size:15px; cursor:pointer; box-shadow:0 4px 15px rgba(16,185,129,0.3);">${tradeConfig.buttonText}</button>
    ...
    if (tradeConfig.amount > 0) {
        const amountInput = document.getElementById('swapAmount');
        if (amountInput) amountInput.value = tradeConfig.amount.toString();
        if (typeof window.updateSwapQuote === 'function') window.updateSwapQuote();
    } else if (typeof window.renderDwalletTradeInsight === 'function') {
        window.renderDwalletTradeInsight();
    }
};
...
window.updateSwapQuote = async function() {
    ...
    if (!amountUi || amountUi <= 0) {
        outInput.value = '';
        if (typeof window.renderDwalletTradeInsight === 'function') window.renderDwalletTradeInsight();
        return;
    }
    
    outInput.value = '계산 중...';
    if (typeof window.renderDwalletTradeInsight === 'function') window.renderDwalletTradeInsight('loading');
    ...
    try {
        const slipBps = (typeof window._swapSlippageBps === 'number' && window._swapSlippageBps > 0) ? window._swapSlippageBps : 500;
        const res = await fetch(`https://api.jup.ag/swap/v1/quote?inputMint=${inputMint}&outputMint=${outputMint}&amount=${amountLamports}&slippageBps=${slipBps}`);
        const data = await res.json();
        ...
        if (data.outAmount) {
            ...
            if (typeof window.renderDwalletTradeInsight === 'function') window.renderDwalletTradeInsight('ready');
        } else {
            outInput.value = '계산 불가';
            if (typeof window.renderDwalletTradeInsight === 'function') window.renderDwalletTradeInsight('error');
        }
    } catch(e) {
...
window.setSendAmountPercent = function(pct, balStr) {
    let bal = parseFloat(balStr.replace(/,/g, '').replace(/[^0-9.]/g, '')) || 0;
    const amt = (bal * pct / 100);
    document.getElementById('sendAmount').value = amt > 0 ? amt.toFixed(2) : '';
};
...
window.showTokenDetails = async function(symbol, mint) {
    ...
    content.style.margin = 'auto'; // Center vertically if taller than screen
    ...
    content.innerHTML = `
        <div style="display:flex; justify-content:space-between; align-items:center; margin-bottom:20px;">
            <h3 style="margin:0; font-size:20px; display:flex; align-items:center; gap:8px;">
                ...
                ${symbol === 'Es9vMFrzaCERmJfrF4H2FYD4KCoNkY11McCe8BenwNYB' ? 'USDT' : symbol} ${t('infoTitle') || '정보'}
            </h3>
        ...
        <div id="tokenDetailsLoading" style="text-align:center; padding:40px 0;">
            ...
            <div style="color:#94a3b8; font-size:14px;">${t('loadingBlockchain') || '블록체인 데이터 불러오는 중...'}</div>
        </div>
    ...
    try {
        ...
        if (data && data.pairs && data.pairs.length > 0) {
            ...
            let basePairs = data.pairs.filter(p => (p.chainId === 'solana' || !p.chainId) && p.baseToken && p.baseToken.address === mint);
            let bestPair = null;
        ...
        const balEl = symbol === 'DDRA' ? document.getElementById('deedraWalletDdraBalance') :
                      ...
                      symbol === 'USDT' ? document.getElementById('deedraWalletUsdtBalance') : null;
        if (balEl) {
        ...
        let usdtExtraHtml = '';
        if (symbol === 'USDT' || symbol === 'Es9vMFrzaCERmJfrF4H2FYD4KCoNkY11McCe8BenwNYB') {
            let solB = 0, bscB = 0, trxB = 0;
            if (window._latestUsdtBalances) {
                solB = window._latestUsdtBalances.sol || 0;
                bscB = window._latestUsdtBalances.bsc || 0;
                trxB = window._latestUsdtBalances.trx || 0;
            } else {
                // If specific network balances aren't loaded yet, try to load them from DOM
                const solEl = document.getElementById('deedraWalletBalance');
                const bscEl = document.getElementById('deedraWalletBnbBalance');
                const tronEl = document.getElementById('deedraWalletTrxBalance');
                
                solB = userBal; // Currently we treat total as SOL in fallback
                bscB = 0;
                trxB = 0;
            }
            
            usdtExtraHtml = `
            <div style="background:rgba(255,255,255,0.02); border:1px solid rgba(255,255,255,0.05); border-radius:16px; padding:18px; margin-top:20px;">
                <h4 style="margin:0 0 16px; font-size:14px; color:#f8fafc; display:flex; align-items:center; gap:8px;"><i class="fas fa-network-wired" style="color:#10b981;"></i> ${t('networkBalanceTitle')||'네트워크별 보유 잔고'}</h4>
                ...
                <div style="display:flex; justify-content:space-between; align-items:center; margin-bottom:12px; padding-bottom:12px; border-bottom:1px solid rgba(255,255,255,0.05);">
                    <div style="display:flex; align-items:center; gap:8px;">
                        <img src="/static/img/solana-logo.png" style="width:20px; height:20px; border-radius:50%;">
                        <span style="color:#cbd5e1; font-size:13px; font-weight:600;">Solana (SPL)</span>
                    </div>
                    <div style="color:#10b981; font-family:monospace; font-size:14px; font-weight:700;">${solB.toLocaleString(undefined, {minimumFractionDigits:2, maximumFractionDigits:4})} <span style="font-size:11px;color:#64748b;">USDT</span></div>
                </div>

                <div style="display:flex; justify-content:space-between; align-items:center; margin-bottom:12px; padding-bottom:12px; border-bottom:1px solid rgba(255,255,255,0.05);">
                    <div style="display:flex; align-items:center; gap:8px;">
                        <img src="/static/img/bnb-logo.png" style="width:20px; height:20px; border-radius:50%;">
                        <span style="color:#cbd5e1; font-size:13px; font-weight:600;">BSC (BEP20)</span>
                    </div>
                    <div style="color:#fcd34d; font-family:monospace; font-size:14px; font-weight:700;">${bscB.toLocaleString(undefined, {minimumFractionDigits:2, maximumFractionDigits:4})} <span style="font-size:11px;color:#64748b;">USDT</span></div>
                </div>

                <div style="display:flex; justify-content:space-between; align-items:center;">
                    <div style="display:flex; align-items:center; gap:8px;">
                        <div style="width:20px; height:20px; border-radius:50%; background:#ef4444; display:flex; align-items:center; justify-content:center; color:#fff; font-size:12px; font-weight:900;">T</div>
                        <span style="color:#cbd5e1; font-size:13px; font-weight:600;">TRON (TRC20)</span>
                    </div>
                    <div style="color:#fca5a5; font-family:monospace; font-size:14px; font-weight:700;">${trxB.toLocaleString(undefined, {minimumFractionDigits:2, maximumFractionDigits:4})} <span style="font-size:11px;color:#64748b;">USDT</span></div>
                </div>
            </div>`;
        }
                ...
                <div style="margin-top:10px;">
                    <button id="currToggleBtn" onclick="
                        ...
                        if (isLocal) {
                            ...
                            this.innerHTML = '${currencySymbol} ${currencyCode} ${t("convertView") || "변환 보기"}';
                            ...
                            this.innerHTML = '$ USD ' + (t('revertView') || '원래대로');
                    ...
                    " style="background:#334155; border:1px solid #475569; color:#cbd5e1; font-size:11px; padding:6px 12px; border-radius:8px; cursor:pointer; font-weight:600; transition:all 0.2s;">
                        ${currencySymbol} ${currencyCode} ${t('convertView') || '변환 보기'}
                    </button>
                </div>
            ` : '';
    ...
    <div style="background:rgba(16,185,129,0.15); border:1px solid rgba(16,185,129,0.3); border-radius:16px; padding:20px; margin-bottom:25px; display:flex; flex-direction:column; gap:12px;">
        <div style="display:flex; justify-content:space-between; align-items:flex-end;">
            <div>
                <div style="font-size:15px; color:#10b981; margin-bottom:6px; font-weight:bold;">${t('myHolding')||'내'} ${symbol === 'Es9vMFrzaCERmJfrF4H2FYD4KCoNkY11McCe8BenwNYB' ? 'USDT' : symbol} ${t('holdingAmt')||'보유량'}</div>
                <div style="font-size:26px; color:#fff; font-weight:900; letter-spacing:0.5px;">${userBal.toLocaleString(undefined, {maximumFractionDigits:4})} ${symbol === 'Es9vMFrzaCERmJfrF4H2FYD4KCoNkY11McCe8BenwNYB' ? 'USDT' : symbol}</div>
            </div>
        </div>
        <div style="width:100%; height:1px; background:rgba(16,185,129,0.2); margin:5px 0;"></div>
        <div style="display:flex; justify-content:space-between; align-items:center;">
            <div style="font-size:15px; color:#94a3b8; font-weight:bold;">${t('currentValue')||'현재 가치'}</div>
            <div style="text-align:right;">
...
` : '';
            ...
            bodyHtml = `
                <div style="text-align:center; margin-bottom:20px;">
                    <div style="font-size:14px; color:#94a3b8; margin-bottom:5px;">${t('currentPrice') || '현재 시세'}</div>
                ...
                <div style="display:grid; grid-template-columns:1fr 1fr 1fr; gap:10px; margin-bottom:25px;">
                    <div style="background:#1e293b; border-radius:12px; padding:15px 10px; text-align:center; border:1px solid #334155;">
                        <div style="font-size:12px; color:#94a3b8; margin-bottom:8px;">${t('h1Change') || '1시간 변화'}</div>
                        <div style="font-size:15px;">${formatChange(priceChange.h1)}</div>
                    </div>
                    <div style="background:#1e293b; border-radius:12px; padding:15px 10px; text-align:center; border:1px solid #334155;">
                        <div style="font-size:12px; color:#94a3b8; margin-bottom:8px;">${t('h6Change') || '6시간 변화'}</div>
                        <div style="font-size:15px;">${formatChange(priceChange.h6)}</div>
                    </div>
                    <div style="background:#1e293b; border-radius:12px; padding:15px 10px; text-align:center; border:1px solid #334155;">
                        <div style="font-size:12px; color:#94a3b8; margin-bottom:8px;">${t('h24Change') || '1일(24h) 변화'}</div>
                ...
                <div style="background:rgba(15,23,42,0.5); border-radius:12px; border:1px solid rgba(255,255,255,0.05); padding:20px;">
                    <div style="font-size:15px; font-weight:bold; margin-bottom:15px; color:#e2e8f0; border-bottom:1px solid rgba(255,255,255,0.1); padding-bottom:10px;">${t('detailSummary') || '상세 정보 요약'}</div>
                    
                    <div style="display:flex; justify-content:space-between; margin-bottom:12px;">
                        <span style="color:#94a3b8; font-size:14px;">${t('marketCap') || '시가총액 (FDV)'}</span>
                        <span style="color:#f8fafc; font-weight:600; font-size:14px;">${formatCurr(fdv)}</span>
                    </div>
                    <div style="display:flex; justify-content:space-between; margin-bottom:12px;">
                        <span style="color:#94a3b8; font-size:14px;">${t('volume24h') || '24시간 거래량'}</span>
                        <span style="color:#f8fafc; font-weight:600; font-size:14px;">${formatCurr(volume)}</span>
                    </div>
                    <div style="display:flex; justify-content:space-between; margin-bottom:12px;">
                        <span style="color:#94a3b8; font-size:14px;">${t('liquidity') || '유동성 (Liquidity)'}</span>
                    ...
                    <div style="display:flex; justify-content:space-between; margin-top:16px; padding-top:16px; border-top:1px dashed rgba(255,255,255,0.1);">
                        <span style="color:#64748b; font-size:12px;">Mint ${t('addressLabel') || '주소'}</span>
            ...
            bodyHtml = `
                <div style="text-align:center; padding:30px 0;">
                    ...
                    <div style="color:#e2e8f0; font-size:16px; margin-bottom:10px;">${t('notFoundTitle') || '시세 정보를 불러올 수 없습니다.'}</div>
                    <div style="color:#94a3b8; font-size:13px; line-height:1.5;">${t('notFoundDesc') || 'DEX 거래소에 아직 상장되지 않았거나 데이터 제공처(DexScreener)에서 지원하지 않는 토큰입니다.'}</div>
                </div>
            `;
        }
        ...
        document.getElementById('tokenDetailsBody').innerHTML = `
            <div style="text-align:center; padding:30px 0;">
                <div style="color:#f43f5e; font-size:15px; margin-bottom:10px;">${t('networkErrorTitle') || '데이터 통신 오류가 발생했습니다.'}</div>
                <div style="color:#94a3b8; font-size:13px;">${t('networkErrorDesc') || '네트워크 상태를 확인하고 다시 시도해주세요.'}</div>
            </div>`;
        document.getElementById('tokenDetailsBody').style.display = 'block';
    }
};
...
window._getDeedraWalletAuthToken = async function() {
    let idToken = window.FB && window.FB._idToken ? window.FB._idToken : '';
    let activeUser = null;
    if (window.FB && window.FB.auth && window.FB.auth.currentUser) {
        activeUser = window.FB.auth.currentUser;
    ...
    if (activeUser && typeof activeUser.getIdToken === 'function') {
        try { idToken = await activeUser.getIdToken(); } catch(e) {}
    }
    return idToken || '';
};

window._fetchDeedraWalletCombinedBalance = async function(publicKey) {
    const [chainResult, ledgerResult] = await Promise.allSettled([
        window._fetchSolanaBalances(publicKey),
        (async () => {
            ...
            const res = await fetch('/api/wallet/balance', {
                ...
                body: JSON.stringify({ publicKey, solanaPublicKey: publicKey })
            });
            const data = await res.json().catch(() => ({}));
            if (!res.ok || data.error) throw new Error(data.error || 'wallet_balance_failed');
            return data;
        })()
    ]);
    ...
    if (ledger.success && ledger.source !== 'ledger') {
        ...
        if (split) {
            window._latestUsdtBalances = {
                ...
                bsc: Number(split.bsc || 0),
                trx: Number(split.tron || 0)
            };
        }
        return {
            success: true,
...
window.toggleAiAssistant = function() {
    ...
    if (!panel) return;
    const isHidden = window.getComputedStyle(panel).opacity === '0' || panel.style.opacity === '0';
    if (isHidden) {
...
window.triggerDidiAction = function(actionType) {
    console.log("triggerDidiAction called with", actionType);
    try {
    ...
    if (actionType === 'analyze') {
        userMsg = '📊 내 자산/승급 목표 AI 분석';
        const rank = userData.rank || 'G0';
        const asset = (walletData.totalInvest || 0) + (walletData.bonusInvest || 0) + (walletData.usdtBalance || 0) + (walletData.bonusBalance || 0);
        aiResponse = `현재 회원님의 등급은 <b>${rank}</b>이며 총 자산은 <b>${asset.toFixed(2)} USDT</b>입니다.<br><br>다음 직급으로 승급하기 위해 네트워크 현황을 스캔하고 있습니다. 자세한 AI 분석 레포트는 곧 지원될 예정입니다!`;
    } else if (actionType === 'simulate') {
        userMsg = '🚀 12개월 VIP 복리 시뮬레이터';
        const invest = (walletData.totalInvest || 0) + (walletData.bonusInvest || 0);
        const expected = invest > 0 ? (invest * 12.5).toFixed(2) : 50000;
        aiResponse = `<b>12개월 VIP 복리 플랜</b>을 시작하시면 일일 0.8%의 데일리 수익이 지속적으로 재투자되어 막대한 스노우볼 효과를 만듭니다.<br><br>현재 투자금(${invest} USDT) 기준 예상 누적 수익은 약 <b>${expected} USDT</b>입니다!`;
    } else if (actionType === 'faq') {
        userMsg = '❓ 자주 묻는 질문 (출금/수수료 등)';
        aiResponse = `<b>💡 자주 묻는 질문 베스트 3</b><br><br>1️⃣ 출금 수수료는 얼마인가요?<br>- DEEDRA 코인으로 스왑 후 출금 시 기본 5%의 수수료가 적용됩니다.<br>2️⃣ 일일 수익은 언제 들어오나요?<br>- 한국 시간 기준 매일 자정(00:00)에 0.8%가 지갑으로 적립됩니다.<br>3️⃣ 수당(직급/추천) 조건은요?<br>- FREEZE 상품이 활성화 상태여야만 롤업 보너스가 지급됩니다.`;
    } else if (actionType === 'market') {
        userMsg = '⚡ 긴급 AI 마켓 브리핑 (투자 전략)';
        aiResponse = `<b>⚡ [긴급] 크립토 마켓 트렌드 브리핑</b><br><br>현재 비트코인 반감기 사이클에 따른 폭발적인 알트코인 유동성이 DEEDRA 토큰 가치 상승에 긍정적인 영향을 주고 있습니다.<br>AI 알고리즘 분석 결과, 지금이 FREEZE 재투자를 통한 <b>지분 확보의 최적기</b>입니다!`;
    }
    ...
    setTimeout(() => {
        ...
        console.error("Didi Error:", err);
    }
};

window.sendDidiMessage = function() {
    ...
    // Simple echo/fallback for manual text
    setTimeout(() => {
        addMessageToChat('ai', '회원님의 소중한 질문을 접수했습니다. DEEDRA 학습형 AI가 해당 내용에 대해 곧 정확한 맞춤 답변을 제공해 드릴 예정입니다!');
    }, 800);
};
...
function addMessageToChat(sender, text) {
    ...
    if (sender === 'user') {
        ...
        div.innerHTML = `
            <div style="background-color: #4f46e5; color: white; padding: 10px 14px; border-radius: 16px; border-top-right-radius: 0; box-shadow: 0 1px 2px rgba(0,0,0,0.1); font-size: 13px; max-width: 85%; word-break: break-word;">
                ${text}
            </div>
        `;
    } else {
        div.innerHTML = `
            ...
            <div style="background-color: white; padding: 12px; border-radius: 16px; border-top-left-radius: 0; box-shadow: 0 1px 2px 0 rgba(0, 0, 0, 0.05); font-size: 13px; color: #334155; line-height: 1.5; border: 1px solid #f1f5f9; max-width: 85%;">
                ${text}
            </div>
        `;
    }
...
window._crashInterval = null;
window._crashMultiplier = 1.00;
window._crashActive = false;
window._crashTarget = 1.00;

window.maxBet = function(type) {
    if (type === 'crash') {
        const maxDdra = Math.max(0.1, Math.floor(gameBalanceVal * 100) / 100);
        window.crashBetVal = maxDdra;
        const el = document.getElementById('crashBetInput');
        if (el) el.value = maxDdra.toFixed(2);
    }
};

window.playCrash = async function() {
    if (GAME_SETTLEMENT_DISABLED) return showGameSettlementDisabled();

    const betStr = document.getElementById('crashBetInput').value;
    const betAmt = parseFloat(betStr);

    if (isNaN(betAmt) || betAmt <= 0) {
        showToast('잘못된 베팅 금액입니다.', 'error');
        return;
    }
    if (gameBalanceVal < betAmt) {
        showToast('잔액 부족 (게임 가능 DDRA: ' + fmt(gameBalanceVal) + ')', 'error');
        return;
    }
    ...
    mulEl.style.color = '#f8fafc';
    
    window._crashMultiplier = 1.00;
    window._crashActive = true;
    
    // Generate crash point
    const random = Math.random();
    window._crashTarget = Math.max(1.00, 0.99 / (1 - random));
    if (window._crashTarget > 100) window._crashTarget = 100.00;
    ...
    const points = [{x: 0, y: 200}];

    window._crashInterval = setInterval(async () => {
        if (!window._crashActive) return;
        
        tick += 0.05;
        window._crashMultiplier = Math.pow(1.05, tick * 10);
        
        if (window._crashMultiplier >= window._crashTarget) {
            clearInterval(window._crashInterval);
            window._crashActive = false;
            window._isGameProcessing = false;
            
            mulEl.textContent = window._crashTarget.toFixed(2) + 'x';
            mulEl.style.color = '#ef4444';
            msgEl.textContent = 'Crashed!';
            ...
            resEl.innerHTML = `<div style="color:#ef4444; font-weight:bold; font-size:16px;">💥 크래시! 베팅 금액을 잃었습니다.</div>`;
            resEl.classList.remove('hidden');
            if (window.SFX && SFX.play) SFX.play('fail');
            
            await recordGameResult('crash', betAmt, 0, false, `Crashed at ${window._crashTarget.toFixed(2)}x`);
        } else {
            mulEl.textContent = window._crashMultiplier.toFixed(2) + 'x';
            if (ctx) {
                ctx.clearRect(0, 0, canvas.width, canvas.height);
                const x = Math.min(canvas.width, tick * 10);
                const y = Math.max(0, 200 - (window._crashMultiplier * 2));
                points.push({x, y});
...
window.cashoutCrash = async function() {
    ...
    const betAmt = parseFloat(document.getElementById('crashBetInput').value);
    const winAmt = betAmt * window._crashMultiplier;
    
    gameBalanceVal += winAmt;
    updateWalletUI();
    ...
    resEl.innerHTML = `<div style="color:#10b981; font-weight:bold; font-size:16px;">🎉 성공! ${winAmt.toFixed(2)} DDRA 획득!</div>`;
    resEl.classList.remove('hidden');
    if (window.SFX && SFX.play) SFX.play('win');
    
    await recordGameResult('crash', betAmt, winAmt, true, `Cashed out at ${window._crashMultiplier.toFixed(2)}x`);
};


// --- Auto-injected i18n patch ---
document.addEventListener('DOMContentLoaded', () => {
    setTimeout(() => {
        if(typeof window.translations !== 'undefined') {
            if(window.translations.ko) {
                window.translations.ko.withdrawableUsdtLabel = "출금 가능 USDT (수익)";
                window.translations.ko.depDeedraDirectTitle = "<i class='fas fa-bolt'></i> 내 디드라 지갑에서 다이렉트 입금";
                window.translations.ko.depManualTitle = "또는 수동 입금 (타 지갑)";
                window.translations.ko.depDeedraDirectDesc = "* 회사 지갑으로 즉시 전송되며 5초 내에 승인됩니다. (수수료 전액 무료)";
            }
            if(window.translations.en) {
                window.translations.en.withdrawableUsdtLabel = "Withdrawable USDT (Earnings)";
                window.translations.en.depDeedraDirectTitle = "<i class='fas fa-bolt'></i> Direct Deposit from Deedra Wallet";
                window.translations.en.depManualTitle = "Or Manual Deposit";
                window.translations.en.depDeedraDirectDesc = "* Instantly transferred and approved in 5 sec. (0% Fee)";
            }
            // Update UI
            document.querySelectorAll('[data-i18n]').forEach(el => {
                const key = el.getAttribute('data-i18n');
                if (['withdrawableUsdtLabel', 'depDeedraDirectTitle', 'depManualTitle', 'depDeedraDirectDesc'].includes(key)) {
...
(function() {
    function injectI18n() {
        if(typeof window.translations !== 'undefined') {
            if(window.translations.ko) {
                ...
                window.translations.ko.depManualTitle = "또는 수동 입금 (타 지갑)";
                window.translations.ko.depDeedraDirectDesc = "* 회사 지갑으로 즉시 전송되며 5초 내에 승인됩니다. (수수료 전액 무료)";
                window.translations.ko.depDeedraDirectAmount = "입금할 금액 (USDT)";
            }
            if(window.translations.en) {
                window.translations.en.withdrawableUsdtLabel = "Withdrawable USDT (Earnings)";
                window.translations.en.depDeedraDirectTitle = "<i class='fas fa-bolt'></i> Direct Deposit from Deedra Wallet";
                window.translations.en.depManualTitle = "Or Manual Deposit";
                window.translations.en.depDeedraDirectDesc = "* Instantly transferred and approved in 5 sec. (0% Fee)";
                window.translations.en.depDeedraDirectAmount = "Amount to deposit (USDT)";
            }
            // Update UI
            document.querySelectorAll('[data-i18n]').forEach(el => {
                const key = el.getAttribute('data-i18n');
                if (['withdrawableUsdtLabel', 'depDeedraDirectTitle', 'depManualTitle', 'depDeedraDirectDesc', 'depDeedraDirectAmount'].includes(key)) {
                    if (el.getAttribute('data-i18n-html') === 'true') {
                        el.innerHTML = t(key);
    ...
    // And also hook into setLanguage function if it exists
    const oldSetLanguage = window.setLanguage;
    if (oldSetLanguage) {
        window.setLanguage = function(lang) {
            oldSetLanguage(lang);
            setTimeout(injectI18n, 100); // Re-inject after DOM updates
        };
    }
    
    // And periodically just in case (e.g. DOM manipulation like opening modals)
    setInterval(injectI18n, 2000);
})();
