...
import {
  getFirestore, initializeFirestore, collection, query, where, getDocs, onSnapshot,
...
const firebaseConfig = await fetch('/api/public/firebase-config', { cache: 'no-store' }).then((r) => {
