...
// 팬텀 스토어 즉시 이동 유틸
window.gotoPhantomStore = function() {
...
// 토큰포켓 스토어 즉시 이동 유틸
window.gotoTokenPocketStore = function() {
  const ua = navigator.userAgent;
  if (/android/i.test(ua)) {
    window.location.href = 'market://details?id=vip.mytokenpocket';
    setTimeout(() => {
      window.location.href = 'https://play.google.com/store/apps/details?id=vip.mytokenpocket';
    }, 500);
  } else if (/ipad|iphone|ipod/i.test(ua)) {
    window.location.href = 'itms-apps://itunes.apple.com/app/tokenpocket-crypto-defi-wallet/id1436028697';
    setTimeout(() => {
      window.location.href = 'https://apps.apple.com/app/tokenpocket-crypto-defi-wallet/id1436028697';
    }, 500);
  } else {
...
window.submitDeposit = async function() {
  ...
  try {
    ...
    await addDoc(collection(db, 'transactions'), {
      ...
      type: 'deposit', amount: parseFloat(amount), currency: 'USDT', txid, memo,
