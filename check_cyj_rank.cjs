...
async function run() {
  ...
  const user = await fsGet('users', 'qAdGKU772oVGZ0B5PwUEbL3UqSF3', token);
  console.log('cyj0300 stats:');
  console.log('  rank:', user.rank);
  console.log('  totalInvest:', user.totalInvest);
  console.log('  downlineInvestStats:', user.downlineInvestStats);
}
run();
