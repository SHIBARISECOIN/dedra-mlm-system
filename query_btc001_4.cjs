...
async function run() {
  ...
  let uid = 'pgUN1pS3cSUwzPYc5DjHKMZWIbE2';
  ...
  let targetBonuses = bonuses.filter(b => b.rawFields.type?.stringValue === 'rank_matching');
  console.log("rank_matching bonuses for btc001:");
